package
{
   ...
   public class HabboMain extends Sprite implements IHabboMain
   {
      ...
      private var var_865:ICore;
      
      private var var_1507:ICoreConfigStatusListener;
      ...
      public function initializeCore() : void
      {
         ...
         {
            Core.crash("Failed to initialize the core: " + error.message,CoreComponent.const_1266,error);
         }
      }
      ...
      {
         initCore("config_habbo.xml",Core.const_969);
      }
      ...
      private function prepareBakedInComponent(param1:Class) : void
      {
         ...
         var_865.prepareComponent(manifest,resource);
      }
      ...
      private function initCore(param1:String, param2:uint) : void
      {
         ...
         var_865 = Core.instantiate(this,param2);
         initBakedInComponents();
         var_865.events.addEventListener(Component.COMPONENT_EVENT_ERROR,onCoreError);
         var_865.loadExternalConfigDocument(new URLRequest(param1),var_1507);
      }
   }
}
