package com.sulake.habbo.catalog.viewer
{
   ...
   public class Product extends ProductGridItem implements IProduct, IGetImageListener
   {
      ...
      private var var_1040:IProductData;
      ...
      {
         super();
         var_1041 = param1.productType;
         var_1039 = param1.furniClassId;
         var_871 = param1.extraParam;
         var_872 = param1.productCount;
         var_1042 = param1.expiration;
         var_1040 = param2;
      ...
      public function initIcon(param1:IProductContainer, param2:IGetImageListener = null) : BitmapData
      {
         ...
         switch(productType)
         {
            ...
            case ProductTypeEnum.const_135:
               _loc6_ = _loc4_.getWallItemIcon(productClassId,param2,var_871);
               break;
