package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class RedeemItemCodeCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_964:IButtonWindow;
      ...
      override public function dispose() : void
      {
         ...
         if(var_964 != null)
         {
            var_964.removeEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         if(var_963 != null)
         {
            var_963.removeEventListener(WindowKeyboardEvent.const_136,windowKeyEventProcessor);
         }
      }
      ...
      {
         super.init();
         var_964 = _window.findChildByName("redeem") as IButtonWindow;
         if(var_964 != null)
         {
            var_964.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onRedeem);
         }
         var_963 = _window.findChildByName("voucher_code") as ITextFieldWindow;
         if(var_963 != null)
         {
            var_963.addEventListener(WindowKeyboardEvent.const_136,windowKeyEventProcessor);
         }
      }
