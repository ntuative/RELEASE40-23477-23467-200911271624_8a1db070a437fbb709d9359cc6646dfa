package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ProductViewCatalogWidget extends CatalogWidget implements ICatalogWidget, IGetImageListener
   {
      ...
      private function onPreviewProduct(param1:SelectProductEvent) : void
      {
         ...
         if(var_528 != null)
         {
            var_528.visible = false;
            var_528.destroyGridItems();
         }
         if(var_1177 != null)
         {
         ...
         if(_loc3_ != null)
         {
            var_1217.text = "${" + _loc3_.name + "}";
            var_1218.text = "${" + _loc3_.description + "}";
         }
         else
         {
            var_1217.text = "${" + _loc2_.localizationId + "}";
            var_1218.text = "${" + _loc2_.localizationId + "}";
         }
         ...
         else
         {
            ...
            switch(_loc2_.pricingModel)
            {
               case Offer.const_395:
                  _loc4_ = var_1178.clone();
                  if(var_528 != null)
                  {
                     var_528.visible = true;
                     (_loc2_.productContainer as BundleProductContainer).populateItemGrid(var_528,var_1177,var_1285);
                  }
                  break;
               ...
               case Offer.const_371:
                  ...
                  {
                     case ProductTypeEnum.const_169:
                     ...
                     case ProductTypeEnum.const_319:
                        ...
                        if(_loc12_.avatarRenderManager != null)
                        {
                           ...
                           if(_loc13_ != null)
                           {
                              ...
                              _loc13_.appendAction(AvatarAction.const_297,AvatarAction.const_596);
                              _loc13_.appendAction(AvatarAction.const_714,_loc6_.productClassId);
                        ...
                        break;
                     case ProductTypeEnum.const_686:
                        break;
                     default:
      ...
      {
         var_1217 = _window.findChildByName("ctlg_product_name") as ITextWindow;
         var_1218 = _window.findChildByName("ctlg_description") as ITextWindow;
         var_92 = _window.findChildByName("ctlg_teaserimg_1") as IBitmapWrapperWindow;
         var_1393 = new Point(var_92.x,var_92.y);
         var_528 = _window.findChildByName("bundleGrid") as IItemGridWindow;
         ...
         var_1178 = _loc2_.content as BitmapData;
