package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class BotCatalogWidget extends CatalogWidget implements ICatalogWidget, IItemGrid
   {
      ...
      {
         super(param1);
         var_857 = _window.findChildByName("botGrid") as IItemGridWindow;
      }
      ...
      {
         var _loc1_:String = var_1480.getValue(var_825.productContainer.firstProduct.extraParam.toLowerCase());
