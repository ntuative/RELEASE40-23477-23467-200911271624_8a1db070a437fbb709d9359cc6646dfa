package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class TextInputCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private var var_927:ITextFieldWindow;
      ...
      {
         super.init();
         var_927 = _window.findChildByName("input_text") as ITextFieldWindow;
         if(var_927 != null)
         {
            var_927.addEventListener(WindowKeyboardEvent.const_830,onKey);
         }
      }
      ...
      private function onKey(param1:WindowKeyboardEvent) : void
      {
         ...
         events.dispatchEvent(new TextInputEvent(var_927.text));
      }
   }
}
