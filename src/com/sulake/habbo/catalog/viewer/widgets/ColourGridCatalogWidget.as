package com.sulake.habbo.catalog.viewer.widgets
{
   ...
   public class ColourGridCatalogWidget extends CatalogWidget implements ICatalogWidget
   {
      ...
      private function select(param1:IWindowContainer) : void
      {
         ...
         if(var_287 != null)
         {
            _loc2_ = var_287.getChildByName("chosen");
            if(_loc2_ != null)
            {
      ...
      override public function init() : void
      {
         ...
         var_1116 = _loc1_.content as XML;
      ...
      private function populateColourGrid() : void
      {
         ...
         var_287 = null;
         for each(_loc1_ in var_1117)
         {
            _loc2_ = page.viewer.catalog.windowManager.buildFromXML(var_1116) as IWindowContainer;
            _loc2_.addEventListener(WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK,onClick);
            _loc2_.background = true;
            _loc2_.color = 4294967295;
            _loc2_.width = var_613.width;
            _loc2_.height = var_613.height;
            _colourGrid.addGridItem(_loc2_);
            _loc3_ = _loc2_.findChildByTag("BG_BORDER") as IBitmapWrapperWindow;
            if(_loc3_ != null)
            {
               _loc3_.bitmap = new BitmapData(var_613.width,var_613.height,true,0);
               _loc3_.bitmap.copyPixels(var_613,var_613.rect,new Point(0,0));
            }
            _loc4_ = _loc2_.findChildByTag("COLOR_IMAGE") as IBitmapWrapperWindow;
            if(_loc4_ != null)
            {
               _loc4_.bitmap = new BitmapData(var_1094.width,var_1094.height,true,0);
               _loc6_ = 255;
               _loc7_ = 255;
               _loc8_ = 255;
               if(_loc1_ > 0)
