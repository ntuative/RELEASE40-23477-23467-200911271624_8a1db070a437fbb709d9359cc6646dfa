package com.sulake.habbo.catalog.recycler
{
   ...
   public class RecyclerLogic implements IRecycler
   {
      ...
      private static const const_739:int = 0;
      ...
      public function setSystemStatus(param1:int, param2:int) : void
      {
         ...
         switch(var_1387)
         {
            case RecyclerStatusMessageEvent.const_1335:
               ...
               break;
            case RecyclerStatusMessageEvent.const_874:
               if(_view == null)
               {
                  return;
               }
      ...
      {
         return var_1387 != RecyclerStatusMessageEvent.const_874;
      }
      
      private function get statusActive() : Boolean
      {
         return var_251 != const_739;
      }
      ...
      {
         return active && var_251 == const_334;
      }
      ...
      public function setFinished(param1:int, param2:int) : void
      {
         ...
         switch(status)
         {
            case RecyclerFinishedMessageEvent.const_961:
               if(_view != null)
               {
                  _view.displayFinishedView();
               }
               break;
            case RecyclerFinishedMessageEvent.const_1127:
      ...
      public function releaseSlot(param1:int) : void
      {
         ...
         if(!var_81.returnInventoryFurniFromRecycler(var_101[param1].id))
         {
            return;
         }
         var_101[param1] = null;
