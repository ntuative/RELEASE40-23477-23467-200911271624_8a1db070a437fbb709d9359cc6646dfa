package com.sulake.habbo.catalog
{
   ...
   public class HabboCatalog extends Component implements IHabboCatalog
   {
      ...
      private var var_662:PurchaseConfirmationDialog;
      
      private var var_777:IHabboSoundManager;
      
      private var var_338:ICatalogViewer;
      
      private var var_1988:Boolean = true;
      
      private var _roomEngine:IRoomEngine;
      
      private var var_1088:IAvatarRenderManager;
      
      private var var_399:ICatalogNavigator;
      ...
      {
         return var_562.getProductData(param1);
      }
      ...
      private function onCreditBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_1989 && var_777 != null)
         {
            var_777.playSound(HabboSoundTypesEnum.const_920);
         }
         var_1989 = false;
      }
      ...
      {
         return var_562.getFurnitureData(param1);
      }
      ...
      private function toggleCatalog(param1:Boolean = false) : void
      {
         ...
         {
            var_204.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.CATALOGUE,_mainContainer));
         }
         if(false)
         {
      ...
      private function createCatalogNavigator() : void
      {
         ...
         var_399 = new CatalogNavigator(this,_loc1_) as ICatalogNavigator;
      ...
      public function showPurchaseConfirmation(param1:Offer, param2:ICatalogPage, param3:String = "") : void
      {
         ...
         else
         {
            if(var_662 == null)
            {
               var_662 = new PurchaseConfirmationDialog(_localization);
            }
            var_662.showOffer(this,param1,param2,param3);
         }
      }
      ...
      public function openCatalogPage(param1:String, param2:Boolean = false) : void
      {
         ...
         {
            toggleCatalog(true);
            var_399.openPage(param1);
         }
      }
      
      private function setHabboToolbarIcon() : void
      {
         var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_111,HabboToolbarIconEnum.CATALOGUE));
      }
      ...
      private function onCatalogIndex(param1:IMessageEvent) : void
      {
         ...
         var_399.buildCatalogIndex(_loc2_);
         if(var_986 != "")
         {
            var_399.openPage(var_986);
            var_986 = "";
         }
         else
         {
            var_399.openFrontPage();
         }
      }
      ...
      {
         if(param1 == null || var_338 == null)
         {
            return;
         }
         var _loc2_:ApproveNameMessageParser = param1.getParser();
         var_338.dispatchWidgetEvent(new CatalogWidgetApproveNameResultEvent(_loc2_.result));
      }
      ...
      private function onPixelsBalance(param1:IMessageEvent) : void
      {
         ...
         updatePurse();
         if(!var_1988 && var_777 != null)
         {
            var_777.playSound(HabboSoundTypesEnum.const_789);
         }
         var_1988 = false;
      }
      ...
      private function getCurrentLayoutCode() : String
      {
         ...
         return var_338.getCurrentLayoutCode();
      }
      ...
      private function onCatalogPage(param1:IMessageEvent) : void
      {
         ...
         var_338.showCatalogPage(_loc4_,_loc5_,_loc8_,_loc3_.offers);
      }
      ...
      private function onRentableBotDefinitions(param1:IMessageEvent) : void
      {
         ...
         var_338.dispatchWidgetEvent(new RentableBotDefinitionWidgetEvent(_loc2_.rentableBots));
      }
      ...
      private function createCatalogViewer() : void
      {
         ...
         var_338 = new CatalogViewer(this,_loc1_,_roomEngine) as ICatalogViewer;
      }
