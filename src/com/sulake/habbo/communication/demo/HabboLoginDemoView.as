package com.sulake.habbo.communication.demo
{
   ...
   public class HabboLoginDemoView extends EventDispatcher
   {
      ...
      public static const const_577:String = "InitConnection";
      ...
      private function onParsedTicketSuccess(param1:Event) : void
      {
         ...
         var_326.shockwaveClientUrl = var_119.shockwaveClientUrl;
         var_326.ssoTicket = var_119.ticket;
         var_119.removeEventListener(SSOTicket.const_323,onParsedTicketSuccess);
         var_119.removeEventListener(SSOTicket.const_248,onParsedTicketFailure);
         var_119 = null;
         dispatchEvent(new Event(const_577));
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = var_326.windowManager.createWindow("habbo_login_window","Login",HabboWindowType.const_305,HabboWindowStyle.const_39,0 | 0,new Rectangle(10,10,320,240),null) as IFrameWindow;
      ...
      private function initSSOTicket() : void
      {
         ...
         var_119 = new SSOTicket(var_326.assets,_loc2_,_loc1_);
         var_119.addEventListener(SSOTicket.const_323,onParsedTicketSuccess);
         var_119.addEventListener(SSOTicket.const_248,onParsedTicketFailure);
      }
