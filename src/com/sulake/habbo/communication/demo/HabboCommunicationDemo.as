package com.sulake.habbo.communication.demo
{
   ...
   public class HabboCommunicationDemo extends Component
   {
      ...
      private function onDisconnectReason(param1:IMessageEvent) : void
      {
         ...
         switch(_loc2_)
         {
            case DisconnectReasonEvent.const_304:
               _loc3_ = _habboConfiguration.getKey("logout.banned.url");
               break;
            case DisconnectReasonEvent.const_785:
               _loc3_ = _habboConfiguration.getKey("logout.concurrent.url");
               break;
            case DisconnectReasonEvent.const_842:
      ...
      private function onConnectionDisconnected(param1:Event) : void
      {
         ...
         if(param1.type == Event.CLOSE && !var_1590)
         {
      ...
      private function onSessionParamsEvent(param1:IMessageEvent) : void
      {
         ...
         if(var_587 != null)
         {
            _loc4_ = new SSOTicketMessageComposer(var_587);
            _loc2_.send(_loc4_);
      ...
      private function sendConnectionParameters(param1:IConnection) : void
      {
         ...
         param1.send(new VersionCheckMessageComposer(401,var_1064,var_1591));
         var _loc2_:String = "";
      ...
      {
         var_587 = _habboConfiguration.getKey("sso.ticket",null);
         var_1064 = _habboConfiguration.getKey("flash.client.url","");
         var_1591 = _habboConfiguration.getKey("external.variables.txt","");
         if(var_163 == null)
         {
         ...
         if(var_587 != null)
         {
            var_74.mode = HabboConnectionType.const_368;
            var_74.initConnection(HabboConnectionType.const_259);
         }
      }
      ...
      private function onConnectionEstablished(param1:Event = null) : void
      {
         ...
         if(_loc2_ != null)
         {
            dispatchLoginStepEvent(HabboCommunicationEvent.const_490);
      ...
      private function onInitCrypto(param1:IMessageEvent) : void
      {
         ...
         switch(var_74.mode)
         {
            case HabboConnectionType.const_368:
               _loc6_ = "";
               ...
               var_877 = _loc4_;
               var_163.loadBannerImage(_loc7_ + "?token=" + var_877,onHotelViewBannerLoaded);
               break;
            case HabboConnectionType.const_1256:
               sendConnectionParameters(_loc2_);
               break;
            case HabboConnectionType.const_1124:
               var_879 = generateRandomHexString(30);
      ...
      private function onHotelViewBannerLoaded(param1:BitmapData) : void
      {
         ...
         var _loc4_:String = xor(_loc3_,var_877);
         ...
         while(_loc12_.length < 64)
         {
            var_879 = generateRandomHexString(30);
            var_421.init(var_879);
            _loc12_ = var_421.getPublicKey(10);
            _loc13_--;
            if(_loc13_ == 0)
            {
            }
      ...
      private function onRoomSessionManagerReady(param1:IID, param2:IUnknown) : void
      {
         ...
         var_34.events.addEventListener(RoomSessionEvent.const_98,onRoomSessionEnded);
      }
