package com.sulake.habbo.window.utils
{
   ...
   public class ProfilerOutput implements IDisposable
   {
      ...
      public function ProfilerOutput(param1:IProfiler, param2:IHabboWindowManager, param3:IWindowRenderer)
      {
         ...
         var_356.addStopEventListener(refresh);
      ...
      {
         var _loc2_:Array = var_356.getProfilerAgentsInArray();
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            _window.dispose();
            _window = null;
            var_356.removeStopEventListener(refresh);
            var_356 = null;
            _windowManager = null;
            var_661 = null;
            _disposed = true;
