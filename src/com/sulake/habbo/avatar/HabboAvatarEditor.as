package com.sulake.habbo.avatar
{
   ...
   public class HabboAvatarEditor extends Component implements IHabboAvatarEditor
   {
      ...
      private var var_893:IFigureData;
      ...
      public function getFigureSetType(param1:String) : ISetType
      {
         ...
         return var_893.getSetType(param1);
      }
      ...
      private function init() : void
      {
         ...
         if(!var_891)
         {
            ...
            var_601["null"] = new FigureData(this);
            var_601["null"] = new FigureData(this);
            _loc1_ = var_601["null"];
            _loc2_ = var_601["null"];
            ...
            var_313 = new Map();
            var_313.add(AvatarEditorCategory.const_940,new GenericModel(this));
            var_313.add(AvatarEditorCategory.const_44,new HeadModel(this));
            var_313.add(AvatarEditorCategory.const_314,new TorsoModel(this));
            var_313.add(AvatarEditorCategory.const_1180,new LegsModel(this));
            var_313.add(AvatarEditorCategory.const_685,new WardrobeModel(this));
            var_891 = true;
         }
      }
      ...
      private function requestSavedOutfits() : void
      {
         ...
         var _loc1_:WardrobeModel = var_313.getValue(AvatarEditorCategory.const_685);
         if(_loc1_ != null)
         {
         }
      }
      ...
      public function get wardrobe() : WardrobeModel
      {
         ...
         return var_313.getValue(AvatarEditorCategory.const_685);
      }
      ...
      public function getPalette(param1:int) : IPalette
      {
         ...
         return var_893.getPalette(param1);
      }
      ...
      public function generateDataContent(param1:IAvatarEditorCategoryModel, param2:String) : CategoryData
      {
         ...
         if(_loc7_ != null)
         {
            ...
            for each(_loc13_ in _loc10_.colors)
            {
               ...
               {
                  _loc16_ = new AvatarEditorColorItem(AvatarEditorView.var_1498.clone() as IWindowContainer,param1,_loc13_);
                  _loc4_.push(_loc16_);
            ...
            for each(_loc5_ in _loc7_.partSets)
            {
               _loc19_ = false;
               _loc20_ = true;
               if(_loc5_.gender == FigureData.const_1135)
               {
                  _loc19_ = true;
               }
      ...
      {
         var _loc2_:IAvatarEditorCategoryModel = var_313.getValue(param1) as IAvatarEditorCategoryModel;
         if(_loc2_ != null)
         {
      ...
      public function openEditor(param1:IWindowContainer = null) : Boolean
      {
         ...
         else
         {
            if(var_359 == null)
            {
               var_359 = _windowManager.createWindow("avatarEditorContainer","",HabboWindowType.const_53,HabboWindowStyle.const_38,0 | 0,new Rectangle(0,0,2,2),null,0) as IWindowContainer;
               var_359.addChild(_view.window);
               var_359.center();
               var_359.visible = false;
            }
         ...
         _view.show();
         toggleAvatarEditorPage(AvatarEditorCategory.const_940);
         if(var_175 != null)
         {
      ...
      private function onAvatarRenderManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_1088 as Component).events.addEventListener(AvatarRenderEvent.AVATAR_RENDER_READY,onAvatarRendererReady);
      }
      ...
      private function onInventoryReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         (var_28 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_700,onHabboClubChanged);
      }
      
      private function onAvatarRendererReady(param1:Event = null) : void
      {
         var_893 = var_1088.getFigureData(AvatarType.const_93);
      }
      ...
      public function loadAvatarInEditor(param1:String, param2:String, param3:Boolean = false) : void
      {
         ...
         var_892 = param3;
         var _loc4_:FigureData = var_601[param2];
         if(_loc4_ == null)
         {
            return;
         }
