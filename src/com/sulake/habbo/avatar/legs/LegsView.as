package com.sulake.habbo.avatar.legs
{
   ...
   public class LegsView implements IAvatarEditorCategoryView
   {
      ...
      public function LegsView(param1:LegsModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_616["null"] = new AvatarEditorGridView(param1,FigureData.const_126,param2,param3);
         var_616["null"] = new AvatarEditorGridView(param1,FigureData.const_160,param2,param3);
         var_616["null"] = new AvatarEditorGridView(param1,FigureData.const_140,param2,param3);
         attachImages();
