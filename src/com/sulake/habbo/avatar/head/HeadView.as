package com.sulake.habbo.avatar.head
{
   ...
   public class HeadView implements IAvatarEditorCategoryView
   {
      ...
      public function HeadView(param1:HeadModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_616["null"] = new AvatarEditorGridView(param1,FigureData.const_117,param2,param3);
         var_616["null"] = new AvatarEditorGridView(param1,FigureData.const_139,param2,param3);
         var_616["null"] = new AvatarEditorGridView(param1,FigureData.const_124,param2,param3);
         var_616["null"] = new AvatarEditorGridView(param1,FigureData.const_144,param2,param3);
         var_616["null"] = new AvatarEditorGridView(param1,FigureData.const_129,param2,param3);
         attachImages();
      ...
      private function setElementImage(param1:IBitmapWrapperWindow, param2:Boolean) : void
      {
         ...
         if(result.length)
         {
            ...
            {
               bmp.bitmap = new BitmapData(bmp.width,bmp.height,false,AvatarEditorView.var_1018);
      ...
      private function changeToCurrentTab() : void
      {
         ...
         var _loc2_:AvatarEditorGridView = var_616[var_1319];
         if(_loc2_ == null)
         {
            return;
         }
