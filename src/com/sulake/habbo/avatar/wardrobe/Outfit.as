package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class Outfit implements IOutfit
   {
      ...
      {
         var_1394 = _controller.avatarRenderManager.createAvatarImage(figure,AvatarScaleType.const_96);
         var_1394.setDirection(AvatarSetType.const_37,int(FigureData.const_839));
         _image = var_1394.getImage(AvatarSetType.const_37);
         _view.udpate(_image);
      }
