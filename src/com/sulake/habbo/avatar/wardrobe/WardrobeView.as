package com.sulake.habbo.avatar.wardrobe
{
   ...
   public class WardrobeView implements IAvatarEditorCategoryView
   {
      ...
      private var var_672:IItemListWindow;
      
      private var var_559:IItemListWindow;
      ...
      public function WardrobeView(param1:WardrobeModel, param2:IHabboWindowManager, param3:IAssetLibrary)
      {
         ...
         var_672 = _window.findChildByName("mylooks") as IItemListWindow;
         var_559 = _window.findChildByName("hotlooks") as IItemListWindow;
         var_821 = _window.findChildByName("selector") as IItemListWindow;
         var_1472 = _window.findChildByName("habboClubNotificationContainer") as IWindowContainer;
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            switch(param2.name)
            {
               ...
               case "habboClubLink":
                  ...
                  var_91.controller.catalog.openCatalogPage(CatalogPageName.const_315,true);
            }
         }
      ...
      private function myLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            var_91.selectMyLook(var_672.getListItemIndex(param2.parent));
         }
      }
      ...
      public function updateHotLooks() : void
      {
         ...
         for each(_loc3_ in var_91.hotLooks)
         {
            ...
            {
               var_559.addListItem(_loc3_.view.window);
      ...
      private function hotLooksEventProc(param1:Event, param2:IWindow = null) : void
      {
         ...
         if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
         {
            _loc3_ = var_822 * 8 + var_559.getListItemIndex(param2.parent);
