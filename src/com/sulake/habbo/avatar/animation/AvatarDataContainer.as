package com.sulake.habbo.avatar.animation
{
   ...
   public class AvatarDataContainer implements IAvatarDataContainer
   {
      ...
      public function AvatarDataContainer(param1:XML)
      {
         ...
         _colorTransform = new ColorTransform(var_1326,var_1330,var_1327,_alphaMultiplier);
         var_951 = generatePaletteMapForGrayscale(var_1878,var_1876);
      }
      
      public function get reds() : Array
      {
         return var_951.getValue("reds") as Array;
      }
      ...
      {
         return var_951.getValue("blues") as Array;
      }
      
      public function get greens() : Array
      {
         return var_951.getValue("greens") as Array;
      }
      ...
      {
         return var_951.getValue("alphas") as Array;
      }
