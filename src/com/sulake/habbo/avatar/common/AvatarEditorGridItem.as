package com.sulake.habbo.avatar.common
{
   ...
   public class AvatarEditorGridItem
   {
      ...
      private const const_1544:int = 16777215;
      ...
      private var var_526:IFigurePartSet;
      ...
      private function updateThumbData() : void
      {
         ...
         if(var_526 != null && false)
         {
            ...
            if(_loc6_ != null)
            {
               ...
               _loc6_.bitmap.copyPixels(var_1325,var_1325.rect,new Point(0,0),null,null,true);
            }
         }
         if(isSelected)
         {
      ...
      private function renderThumb() : BitmapData
      {
         ...
         _loc1_ = new BitmapData(var_759.width,var_759.height,true,16777215);
         for each(_loc2_ in partSet.parts.concat().sort(sortByDrawOrder))
         {
            _loc3_ = "undefined_undefined_" + _loc2_.type + "_" + _loc2_.id + "_" + FigureData.const_804 + "_" + FigureData.const_244;
            ...
            if(_loc4_ != null)
            {
               ...
               if(_color != null && var_936 && _loc2_.isColorable)
               {
      ...
      private function analyzeLayers() : void
      {
         ...
         {
            _loc2_ = "undefined_undefined_" + _loc1_.type + "_" + _loc1_.id + "_" + FigureData.const_804 + "_" + FigureData.const_244;
