package com.sulake.habbo.avatar.common
{
   public class CategoryData
   {
      ...
      public function get currentColour() : AvatarEditorColorItem
      {
         if(var_602 > -1)
         {
            return var_314[var_602] as AvatarEditorColorItem;
         }
         return null;
      }
      ...
      public function selectColour(param1:int) : AvatarEditorColorItem
      {
         ...
         if(var_602 >= 0)
         {
            _loc3_ = var_314[var_602];
            _loc3_.isSelected = false;
         }
         if(var_314.length > param1)
         {
            _loc2_ = var_314[param1] as AvatarEditorColorItem;
            _loc2_.isSelected = true;
         }
         var_602 = param1;
