package com.sulake.habbo.avatar
{
   ...
   public class AvatarEditorView
   {
      ...
      public static var var_1498:IWindowContainer;
      
      public static var var_1273:IWindowContainer;
      
      public static var var_1018:int = 6710886;
      ...
      private var var_1417:ITabSelectorWindow;
      ...
      public function AvatarEditorView(param1:HabboAvatarEditor, param2:IHabboWindowManager)
      {
         ...
         if(var_1498 == null)
         {
            ...
            var_1498 = _controller.windowManager.buildFromXML(_loc4_.content as XML) as IWindowContainer;
         }
      ...
      private function createWindow() : void
      {
         ...
         var_1417 = _window.findChildByName("mainTabs") as ITabSelectorWindow;
         attachImages();
         updateAvatar();
      }
      ...
      private function setViewToCategory(param1:String) : void
      {
         ...
         var_684 = param1;
         var_1417.setSelected(var_1417.getSelectableByName(param1));
         _window.invalidate();
      }
