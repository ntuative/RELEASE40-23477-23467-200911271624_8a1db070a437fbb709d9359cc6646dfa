package com.sulake.habbo.avatar
{
   ...
   public class AvatarStructure extends EventDispatcher
   {
      ...
      private var var_1514:PartOffsetData;
      ...
      private var var_1291:AvatarStructureDownloadSet;
      
      private var var_693:AvatarActionManager;
      
      private var var_149:IAssetLibrary;
      
      private var var_416:FigureData;
      
      private var var_2149:IAssetLibrary;
      
      private var var_1282:Boolean = false;
      
      private var var_581:AnimationManager;
      
      private var var_1513:AvatarRenderManager;
      ...
      public function AvatarStructure(param1:AvatarRenderManager, param2:IAssetLibrary, param3:IAssetLibrary, param4:String)
      {
         ...
         var_149 = param2;
         var_2149 = param3;
         var_416 = new FigureData();
         var_355 = new PartSetsData();
         _animationData = new AnimationData();
         var_1291 = new AvatarStructureDownloadSet();
         var_581 = new AnimationManager();
         var_694 = param4;
         var_1514 = PartOffsetData.getInstance(param3);
      }
      
      public function getBodyParts(param1:String, param2:IActionDefinition, param3:int) : Array
      {
         var _loc4_:Number = AvatarDirectionAngle.const_1116[param3];
      ...
      {
         return var_693.getActionDefinitionWithState(param1);
      }
      
      public function getAnimation(param1:String) : Animation
      {
         return var_581.getAnimation(param1);
      }
      ...
      public function init(param1:IHabboConfigurationManager) : void
      {
         ...
         switch(var_694)
         {
            case AvatarType.const_93:
               _loc3_ = var_149.getAssetByName("HabboAvatarPartSets").content as XML;
               if(!var_355.parse(_loc3_))
               {
                  return;
               }
               _loc4_ = var_149.getAssetByName("HabboAvatarAnimation").content as XML;
               if(!_animationData.parse(_loc4_))
               {
                  return;
               }
               _loc5_ = var_149.getAssetByName("HabboAvatarFigure").content as XML;
               if(!var_416.parse(_loc5_))
               {
                  return;
               }
               var_1291.add(new AvatarStructureDownload(var_149,_loc2_,var_416));
               _loc6_ = true;
               break;
            case AvatarType.PET:
               _loc3_ = var_149.getAssetByName("HabboAvatarPetPartSets").content as XML;
               if(!var_355.parse(_loc3_))
               {
                  return;
               }
               _loc4_ = var_149.getAssetByName("HabboAvatarPetAnimation").content as XML;
               if(!_animationData.parse(_loc4_))
               {
                  return;
               }
               _loc5_ = var_149.getAssetByName("HabboAvatarPetFigure").content as XML;
               if(!var_416.parse(_loc5_))
               {
                  return;
               }
         ...
         if(_loc6_)
         {
            var_1291.addEventListener(AvatarStructureDownloadSet.DOWNLOAD_SET_DONE,method_4);
         }
         else
         {
            method_4();
      ...
      {
         return var_693.getCanvasOffsets(param1,param2,param3);
      }
      ...
      {
         return var_693.getActionDefinition(param1);
      }
      
      private function initActions() : void
      {
         var_693 = new AvatarActionManager(var_149,var_694);
      }
      ...
      public function getActiveBodyPartIds(param1:IActiveActionData) : Array
      {
         ...
         if(param1.definition.isAnimation)
         {
            ...
            _loc7_ = var_581.getAnimation(_loc6_);
            if(_loc7_ != null)
            {
               ...
               if(_loc7_.hasAddData())
               {
                  for each(_loc9_ in _loc7_.addData)
                  {
                     ...
                     if(_loc5_ != null)
                     {
                        ...
                        _loc12_ = var_355.addPartDefinition(_loc11_);
         ...
         {
            _loc2_ = var_355.getActiveParts(param1.definition);
      ...
      public function getParts(param1:String, param2:AvatarFigureContainer, param3:IActiveActionData, param4:String, param5:int) : Array
      {
         ...
         var _loc6_:ActionDefinition = var_693.getDefaultActionType();
         var _loc7_:Array = var_355.getActiveParts(param3.definition);
         if(param3.definition.isAnimation)
         {
            _loc17_ = param3.definition.state + "." + param3.actionParameter;
            _loc8_ = var_581.getAnimation(_loc17_);
            if(_loc8_ != null)
            {
         ...
         for each(_loc14_ in param2.getPartTypeIds())
         {
            ...
            _loc23_ = var_416.getSetType(_loc14_);
            if(_loc23_ != null)
            {
               _loc24_ = var_416.getPalette(_loc23_.paletteID).getColor(_loc22_);
               ...
               if(_loc25_ != null)
               {
                  ...
                  for each(_loc26_ in _loc25_.parts)
                  {
                     if(_loc9_.indexOf(_loc26_.type) > -1)
                     {
                        ...
                        _loc13_ = var_355.getPartDefinition(_loc26_.type);
         ...
         for each(_loc11_ in _loc9_)
         {
            ...
            if(!_loc33_)
            {
               if(_loc7_.indexOf(_loc11_) > -1)
               {
                  ...
                  {
                     _loc13_ = var_355.getPartDefinition(_loc11_);
                     _loc35_ = false;
                     _loc36_ = 1;
      ...
      private function initGeometry() : void
      {
         ...
         {
            case AvatarType.const_93:
               if(var_149.hasAsset("HabboAvatarGeometry"))
               {
                  _loc1_ = var_149.getAssetByName("HabboAvatarGeometry").content as XML;
               ...
               break;
            case AvatarType.PET:
               if(var_149.hasAsset("HabboAvatarPetGeometry"))
               {
                  _loc1_ = var_149.getAssetByName("HabboAvatarPetGeometry").content as XML;
                  _geometry = new AvatarModelGeometry(_loc1_);
               }
               else
               {
      ...
      private function registerAnimations() : void
      {
         var _loc2_:* = null;
         var _loc1_:int = 1;
         while(var_149.hasAsset("dance" + _loc1_))
         {
            _loc2_ = var_149.getAssetByName("dance" + _loc1_).content as XML;
            var_581.registerAnimation(this,_loc2_);
            _loc1_++;
         }
         _loc1_ = 1;
         while(var_149.hasAsset("fx" + _loc1_))
         {
            _loc2_ = var_149.getAssetByName("fx" + _loc1_).content as XML;
            var_581.registerAnimation(this,_loc2_);
            _loc1_++;
         }
      }
      ...
      public function getPartColor(param1:AvatarFigureContainer, param2:String) : IPartColor
      {
         ...
         var _loc4_:ISetType = var_416.getSetType(param2);
         if(_loc4_ == null)
         {
            return null;
         }
         return var_416.getPalette(_loc4_.paletteID).getColor(_loc3_);
      }
      ...
      private function method_4(param1:Event = null) : void
      {
         ...
         {
            var_355.getPartDefinition("ri").appendToFigure = true;
            var_355.getPartDefinition("li").appendToFigure = true;
         }
         registerAnimations();
      ...
      {
         return var_693.sortActions(param1);
      }
   }
}
