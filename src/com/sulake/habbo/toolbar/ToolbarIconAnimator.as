package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconAnimator
   {
      ...
      public function ToolbarIconAnimator(param1:StateItem, param2:IAssetLibrary, param3:IBitmapWrapperWindow, param4:Number, param5:Number, param6:BitmapData = null)
      {
         ...
         var_1082 = param1.loop;
         if(param1.background != null)
         {
            var_709 = getBitmapDataFromAsset(param1.background,param2);
         }
         ...
         else
         {
            ...
            if(_loc8_ != null)
            {
               var_711.push(new XML());
               var_710.push(_loc8_);
            }
         }
         if(param6 != null)
         {
            var_710[var_58] = param6.clone();
         }
      ...
      {
         if(var_1082 == true || var_599 == 0)
         {
            if(false)
            {
               ++var_58;
               if(var_58 >= var_711.length)
               {
                  var_58 = 0;
                  ++var_599;
               }
      ...
      {
         return var_1082 == false && var_599 == 1 && var_1249 != _state;
      }
      ...
      private function setAsset(param1:IBitmapWrapperWindow, param2:BitmapData) : void
      {
         ...
         if(var_709 != null)
         {
            _loc3_ = new BitmapData(Math.max(param2.width,var_709.width),Math.max(param2.height,var_709.height));
            _loc3_.copyPixels(var_709,var_709.rect,new Point(0,0));
      ...
      {
         var _loc2_:* = null;
         if(var_58 <= var_710.length)
         {
            _loc2_ = var_710[var_58];
