package com.sulake.habbo.toolbar
{
   ...
   public class HabboToolbar extends Component implements IHabboToolbar
   {
      ...
      private function onWindowManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_588.addHabboConnectionMessageEvent(new AuthenticationOKMessageEvent(onAuthenticationOK));
      }
      ...
      private function onAuthenticationOK(param1:IMessageEvent) : void
      {
         ...
         events.addEventListener(HabboToolbarSetIconEvent.const_863,onSetToolbarIconBitmapEvent);
         ...
         events.addEventListener(HabboToolbarShowMenuEvent.const_374,onAnimateWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_713,onDisplayWindowEvent);
         events.addEventListener(HabboToolbarShowMenuEvent.const_943,onHideWindowEvent);
         _state = true;
         events.dispatchEvent(new HabboToolbarEvent(HabboToolbarEvent.const_76));
      }
