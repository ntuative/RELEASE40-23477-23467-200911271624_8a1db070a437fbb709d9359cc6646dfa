package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarIconGroup
   {
      ...
      {
         return var_1135.indexOf(param1) > -1;
      }
      ...
      {
         return var_619.indexOf(param1) > -1;
      }
      ...
      private function alignItems() : void
      {
         ...
         var _loc3_:* = 0;
         var _loc4_:int = 0;
         while(_loc4_ < var_1134.length)
         {
            _loc2_ = var_619.indexOf(var_1134[_loc4_]);
            if(_loc2_ > -1)
            {
               _loc1_ = var_284[_loc2_];
               if(_loc1_.exists)
               {
      ...
      {
         var _loc3_:* = null;
         var _loc2_:int = var_619.indexOf(param1);
         if(_loc2_ > -1)
         {
            _loc3_ = getIconById(param1);
            if(_loc3_ != null)
      ...
      public function getIconById(param1:String) : ToolbarIcon
      {
         ...
         return var_284[var_619.indexOf(param1)];
      }
      ...
      public function getMenuYieldList(param1:String) : Array
      {
         ...
         var _loc3_:XMLList = var_1757.elements("menu");
         var _loc5_:int = 0;
