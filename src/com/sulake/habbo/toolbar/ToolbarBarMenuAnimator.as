package com.sulake.habbo.toolbar
{
   ...
   public class ToolbarBarMenuAnimator
   {
      ...
      private static const const_1060:Number = 25;
      
      private static const const_1061:int = 50;
      
      private static const const_174:Boolean = true;
       
      
      private var var_552:Timer;
      
      private var var_982:ToolbarView;
      ...
      public function ToolbarBarMenuAnimator(param1:IHabboWindowManager, param2:ToolbarView)
      {
         ...
         var_982 = param2;
         var_552 = new Timer(const_1060);
         var_552.addEventListener(TimerEvent.TIMER,animationUpdate);
      }
      ...
      private function registerWindow(param1:IWindowContainer, param2:String) : void
      {
         ...
         param1.addEventListener(WindowEvent.const_188,windowEventListener);
      }
      ...
      private function createItemObject(param1:String, param2:ToolbarIcon) : MenuAnimatorItem
      {
         ...
         if(_loc3_ == null)
         {
            ...
            _loc4_ = var_982.getIconByMenuId(param1);
            if(_loc4_ == null)
            {
               return null;
            }
      ...
      public function removeItem(param1:String) : void
      {
         if(var_295.indexOf(param1) > -1)
         {
            ...
            else
            {
               ...
               var_295.splice(var_295.indexOf(param1),1);
            }
         }
      }
      ...
      {
         var _loc2_:Point = var_982.getIconLoc(param1.iconId);
      ...
      public function refresh() : void
      {
         ...
         {
            repositionWindow(var_295[_loc1_],true);
            _loc1_++;
         }
      }
      ...
      private function registerDependentMenu(param1:String, param2:Array) : void
      {
         ...
         while(_loc4_ < param2.length)
         {
            ...
            if(true)
            {
               var_551[_loc3_] = new Array();
            }
            if(var_551[_loc3_].indexOf(param1) < 0)
            {
               var_551[_loc3_].push(param1);
            }
            _loc4_++;
         }
      }
      ...
      {
         return param1.x + param1.width < const_758 + _toolbarSize || param1.y < 0 || param1.desktop.width - param1.x < const_758 || param1.desktop.height - param1.y < const_1061;
      }
      ...
      public function windowEventListener(param1:WindowEvent) : void
      {
         ...
         while(_loc2_ < var_474.length)
         {
            if(var_474[_loc2_] == param1.window.name)
            {
               ...
               {
                  _loc4_ = 0;
                  while(_loc4_ < var_551[_loc3_].length)
                  {
                     repositionWindow(var_551[_loc3_][_loc4_],false);
                     _loc4_++;
                  }
               }
            }
