package com.sulake.habbo.friendlist
{
   ...
   public class HabboFriendList extends Component implements IHabboFriendList
   {
      ...
      private var var_1913:IAvatarRenderManager;
      
      private var var_1433:AvatarSearchResults;
      ...
      var var_313:FriendCategories;
      
      private var var_204:IHabboToolbar;
      
      private var var_1914:FriendListLookAndFeel;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_404:FriendListTabs;
      
      private var var_1915:IHabboNotifications;
      
      private var _localization:IHabboLocalizationManager;
      
      private var var_1432:OpenedToWebPopup;
      ...
      {
         var_1914 = new FriendListLookAndFeel();
         super(param1,param2,param3);
         var_313 = new FriendCategories(new FriendCategoriesDeps(this));
         var_1433 = new AvatarSearchResults(new AvatarSearchDeps(this));
      ...
      public function openHabboWebPage(param1:String, param2:Dictionary, param3:int, param4:int) : void
      {
         ...
         if(var_1432 == null)
         {
            var_1432 = new OpenedToWebPopup(this);
         }
         var_1432.show(x,y);
      }
      ...
      private function onBuddyRequests(param1:IMessageEvent) : void
      {
         ...
         {
            var_404.findTab(FriendListTab.const_92).setNewMessageArrived(true);
            refreshToolBarIcon();
         }
      ...
      public function getFriend(param1:int) : IFriend
      {
         ...
         return var_313.findFriend(param1);
      }
      ...
      private function onMessengerInit(param1:IMessageEvent) : void
      {
         ...
         {
            var_313.addCategory(new FriendCategory(_loc3_.id,_loc3_.name));
         }
         var_313.addCategory(new FriendCategory(FriendCategory.const_846,getText("friendlist.friends")));
         var_313.addCategory(new FriendCategory(FriendCategory.const_400,getText("friendlist.friends.offlinecaption")));
         for each(_loc4_ in getSortedFriends(_loc2_.friends))
         {
            var_313.addFriend(new Friend(_loc4_));
         }
         var_404 = new FriendListTabs(new FriendListTabsDeps(this));
         _loc5_ = new Timer(120000);
         _loc5_.addEventListener(TimerEvent.TIMER,sendFriendListUpdate);
         _loc5_.start();
         getBuddyRequests();
         registerListeners();
         var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_111,HabboToolbarIconEnum.FRIENDLIST));
      ...
      {
         var_313.onFriendListUpdate(param1);
      ...
      {
         var _loc2_:IAvatarImage = var_1913.createAvatarImage(param1,AvatarScaleType.const_96);
      ...
      private function onAvatarRenderedReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1913 = param2 as IAvatarRenderManager;
      ...
      private function onNewBuddyRequest(param1:IMessageEvent) : void
      {
         ...
         var _loc4_:FriendListTab = var_404.findTab(FriendListTab.const_92);
      ...
      {
         var_1915 = param2 as IHabboNotifications;
      ...
      public function getFriendCount(param1:Boolean, param2:Boolean) : int
      {
         ...
         return this.var_313.getFriendCount(param1,param2);
      }
      ...
      private function toggleWindow() : void
      {
         ...
         {
            _view.openFriendList();
            _loc1_ = var_404.findSelectedTab();
            if(_loc1_ == null)
            {
      ...
      private function onHabboSearchResult(param1:IMessageEvent) : void
      {
         ...
         var_1433.searchReceived(_loc2_.friends,_loc2_.others);
