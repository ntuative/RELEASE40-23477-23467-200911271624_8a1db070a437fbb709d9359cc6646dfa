package com.sulake.habbo.friendlist
{
   ...
   public class FriendRequestsView implements ITabView, IFriendRequestsView
   {
      ...
      private function onAcceptAllButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         {
            if(_loc4_.state != FriendRequest.const_309 && _loc4_.state != FriendRequest.const_316)
            {
      ...
      {
         var_1446 = IContainerButtonWindow(param1.findChildByName("accept_all_but"));
         var_1447 = IContainerButtonWindow(param1.findChildByName("reject_all_but"));
         var_1447.procedure = onDismissAllButtonClick;
         var_1446.procedure = onAcceptAllButtonClick;
         refreshButtons();
      }
      ...
      public function refreshRequestEntry(param1:FriendRequest) : void
      {
         ...
         if(param1.state == FriendRequest.const_138)
         {
         ...
         else if(param1.state == FriendRequest.const_876)
         {
      ...
      private function refreshButtons() : void
      {
         ...
         setEnabled(var_1446,_loc1_);
         setEnabled(var_1447,_loc1_);
      }
