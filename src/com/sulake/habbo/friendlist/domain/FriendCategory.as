package com.sulake.habbo.friendlist.domain
{
   ...
   public class FriendCategory implements IDisposable
   {
      ...
      public static const const_846:int = 0;
      
      public static const const_400:int = -1;
      
      public static const const_326:int = 100;
      ...
      {
         return Math.ceil(this.var_231.length / const_326);
      }
      ...
      public function addFriend(param1:Friend) : void
      {
         ...
         {
            _loc4_ = var_231[_loc3_];
            if(_loc2_ < _loc4_.name.toLowerCase())
            {
               var_231.splice(_loc3_,0,param1);
               return;
            }
            _loc3_++;
         }
      ...
      {
         checkPageIndex();
         return Math.min((this.var_818 + 1) * const_326,this.var_231.length);
      }
