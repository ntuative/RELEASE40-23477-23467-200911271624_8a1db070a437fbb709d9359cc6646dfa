package com.sulake.habbo.friendlist.domain
{
   ...
   public class Friend implements IFriend, IDisposable
   {
      ...
      public static const const_1467:int = "F".charCodeAt(0);
      
      public static const const_1492:int = "M".charCodeAt(0);
      ...
      public function Friend(param1:FriendData)
      {
         ...
         var_643 = param1.online;
         var_1087 = param1.followingAllowed && param1.online;
         var_542 = param1.figure;
         var_1086 = param1.motto;
         var_1084 = param1.lastAccess;
         var_1085 = param1.categoryId;
         var_1083 = param1.realName;
