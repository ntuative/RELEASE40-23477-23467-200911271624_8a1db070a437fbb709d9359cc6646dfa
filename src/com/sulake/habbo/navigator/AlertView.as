package com.sulake.habbo.navigator
{
   ...
   public class AlertView implements IDisposable
   {
      ...
      private static var var_1468:Dictionary = new Dictionary();
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(_navigator.getXmlWindow(this.var_1254));
      ...
      {
         var _loc1_:IFrameWindow = IFrameWindow(var_1468[var_1254]);
         if(_loc1_ != null)
         {
            _loc1_.dispose();
         }
         ...
         var _loc2_:Rectangle = Util.getLocationRelativeTo(var_265.desktop,var_265.width,var_265.height);
         var_265.x = _loc2_.x;
         var_265.y = _loc2_.y;
         var_1468[var_1254] = var_265;
      }
   }
}
