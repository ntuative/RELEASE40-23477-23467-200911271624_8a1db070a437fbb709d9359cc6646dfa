package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomSettingsCtrl
   {
      ...
      private var var_1186:TextFieldManager;
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow(param1,"",HabboWindowType.const_53,HabboWindowStyle.const_38,HabboWindowParam.const_64,new Rectangle(0,0,100,20)));
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         _loc2_.addEventListener(WindowEvent.const_697,onDoorModePasswordSelect);
         _loc2_.addEventListener(WindowEvent.const_779,onDoorModePasswordUnselect);
         ...
         refreshCategories();
         this.var_766 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("room_name")),60);
         this.var_1184 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("description")),255);
         this.var_725 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag1")),30);
         this.var_727 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("tag2")),30);
         this.var_945 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password")),30);
         this.var_1186 = new TextFieldManager(_navigator,ITextFieldWindow(_window.findChildByName("password_confirm")),30);
         this.var_1401 = ICheckBoxWindow(_window.findChildByName("allow_pets_checkbox"));
         ...
         var_947 = IWindowContainer(_window.findChildByName("advanced_settings_container"));
         ...
         var_1865 = ITextWindow(_window.findChildByName("basic_caption"));
         var_1864 = ITextWindow(_window.findChildByName("advanced_caption"));
      ...
      public function refresh(param1:IWindowContainer) : void
      {
         ...
         var_1864.visible = var_454;
         var_1865.visible = !var_454;
         if(var_454)
         {
         ...
         var_1397.text = !!var_454 ? "${navigator.roomsettings.tobasicsettings}" : "${navigator.roomsettings.toadvancedsettings}";
         Util.moveChildrenToColumn(_window,[var_1399.name,var_1187.name,var_946.name,var_947.name,var_1185.name,var_1398.name],0,0);
      ...
      private function populateForm() : void
      {
         ...
         setTag(var_725,_loc1_.tags[0]);
         setTag(var_727,_loc1_.tags[1]);
         if(_loc1_.allowPets)
         {
      ...
      private function onSaveButtonClick(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "doormode_password":
               ...
               break;
            default:
               _loc2_.doorMode = RoomSettingsFlatInfo.const_351;
         }
         if(_loc2_.doorMode == RoomSettingsFlatInfo.const_119)
         {
            _loc8_ = var_945.getText();
            _loc9_ = var_1186.getText();
            if(_loc8_ != _loc9_)
            {
               this.var_945.clearErrors();
               this.var_1186.displayError("${navigator.roomsettings.invalidconfirm}");
               return;
            }
            if(_loc8_ != "")
            {
         ...
         _loc2_.allowPets = var_1401.isSelected;
         ...
         addTag(var_725,_loc2_.tags);
         addTag(var_727,_loc2_.tags);
         this.clearErrors();
         this.var_944 = _loc2_.roomId;
      ...
      {
         if(param1 != this.var_381 || var_944 < 1)
         {
            return;
         }
         close();
      ...
      public function onRoomSettingsSaveError(param1:int, param2:int, param3:String) : void
      {
         ...
         {
            this.var_766.displayError("${navigator.roomsettings.roomnameismandatory}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1136)
         {
            this.var_766.displayError("${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1214)
         {
         ...
         {
            setTagError(this.var_725,param3,"${navigator.roomsettings.unacceptablewords}");
            setTagError(this.var_727,param3,"${navigator.roomsettings.unacceptablewords}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1234)
         {
            setTagError(this.var_725,param3,"${navigator.roomsettings.nonuserchoosabletag}");
            setTagError(this.var_727,param3,"${navigator.roomsettings.nonuserchoosabletag}");
         }
         else if(param2 == RoomSettingsSaveErrorMessageParser.const_1162)
         {
            this.var_945.displayError("${navigator.roomsettings.passwordismandatory}");
         }
         else
         {
            this.var_766.displayError("Update failed: error " + param2);
         }
      }
