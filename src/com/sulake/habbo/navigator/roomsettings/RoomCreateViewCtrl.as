package com.sulake.habbo.navigator.roomsettings
{
   ...
   public class RoomCreateViewCtrl
   {
      ...
      private var var_797:RoomLayout;
      ...
      public function RoomCreateViewCtrl(param1:HabboNavigator)
      {
         super();
         _navigator = param1;
         var_1214 = new Timer(100);
         var_1214.addEventListener(TimerEvent.TIMER,updateArrowPos);
         var_68 = new Array();
      ...
      private function prepare() : void
      {
         ...
         var_976 = new TextFieldManager(_navigator,ITextFieldWindow(var_33.findChildByName("room_name_input")),25,null,_navigator.getText("navigator.createroom.roomnameinfo"));
      ...
      private function onCreateButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var _loc3_:String = var_976.getText();
      ...
      private function refreshRoomThumbnails() : void
      {
         ...
         var_1940 = _navigator.data.hcMember;
      }
      ...
      {
         var_976.goBackToInitialState();
         var_976.input.textBackgroundColor = 4294967295;
         var_797 = var_68[0];
         if(var_1940 != _navigator.data.hcMember)
         {
      ...
      {
         return IWindowContainer(_navigator.windowManager.createWindow("","",HabboWindowType.const_53,HabboWindowStyle.const_38,HabboWindowParam.const_64,new Rectangle(0,0,100,300)));
      }
      ...
      {
         var _loc1_:Boolean = var_976.checkMandatory(_navigator.getText("navigator.createroom.nameerr"));
      ...
      {
         var _loc3_:IBitmapWrapperWindow = IBitmapWrapperWindow(var_797.view.findChildByName("select_arrow"));
