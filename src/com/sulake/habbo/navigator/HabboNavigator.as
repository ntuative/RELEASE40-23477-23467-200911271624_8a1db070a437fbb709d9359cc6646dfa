package com.sulake.habbo.navigator
{
   ...
   public class HabboNavigator extends Component implements IHabboNavigator
   {
      ...
      private var var_2222:Dictionary;
      ...
      private var var_1534:ISessionDataManager;
      
      private var var_1533:RoomCreateViewCtrl;
      
      private var var_1531:RoomThumbnailRenderer;
      
      private var var_204:IHabboToolbar;
      
      private var _communication:IHabboCommunicationManager;
      
      private var var_1049:RoomInfoViewCtrl;
      
      private var var_81:IHabboCatalog;
      
      private var var_404:Tabs;
      
      private var var_417:MainViewCtrl;
      ...
      public function HabboNavigator(param1:IContext, param2:uint = 0, param3:IAssetLibrary = null)
      {
         ...
         var_417 = new MainViewCtrl(this);
         var_1049 = new RoomInfoViewCtrl(this);
         var_1533 = new RoomCreateViewCtrl(this);
         var_1531 = new RoomThumbnailRenderer(this);
         var_945 = new GuestRoomPasswordInput(this);
         var_308 = new GuestRoomDoorbell(this);
         var_404 = new Tabs(this);
      }
      ...
      public function performTagSearch(param1:String) : void
      {
         ...
         var_417.startSearch(Tabs.const_198,Tabs.const_295,param1);
         var_417.mainWindow.activate();
      }
      ...
      public function animateWindowOpen(param1:IWindowContainer) : void
      {
         ...
         {
            var_204.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.NAVIGATOR,param1));
         }
      }
      ...
      private function setHabboToolbarIcon() : void
      {
         if(var_204 != null)
         {
            var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_111,HabboToolbarIconEnum.NAVIGATOR));
            if(this._data != null && this._data.settings != null && this._data.settings.homeRoomId > 0)
            {
               var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_111,HabboToolbarIconEnum.EXITROOM));
            }
         }
      }
      ...
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1534 = param2 as ISessionDataManager;
      }
      ...
      public function showOwnRooms() : void
      {
         ...
         var_417.startSearch(Tabs.const_267,Tabs.const_183);
         var_404.getTab(Tabs.const_267).tabPageDecorator.tabSelected();
      }
      ...
      {
         var _loc1_:Boolean = var_417.onNavigatorToolBarIconClick();
         if(_loc1_)
         {
