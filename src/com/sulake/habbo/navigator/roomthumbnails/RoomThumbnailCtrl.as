package com.sulake.habbo.navigator.roomthumbnails
{
   ...
   public class RoomThumbnailCtrl
   {
      ...
      {
         setEnabled(_bgTabButton,this.var_91.mode != ThumbnailEditorModel.const_33);
         setEnabled(var_1371,this.var_91.mode != ThumbnailEditorModel.const_52);
         setEnabled(var_1372,this.var_91.mode != ThumbnailEditorModel.const_31);
      }
      ...
      private function onBgTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_91.mode = ThumbnailEditorModel.const_33;
         this.reload();
      }
      ...
      private function onTopTabButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         this.var_91.mode = ThumbnailEditorModel.const_52;
         this.reload();
      }
      ...
      private function prepareWindow(param1:IWindowContainer) : void
      {
         ...
         var_1371 = IButtonWindow(find("top_tab"));
         var_1372 = IButtonWindow(find("obj_tab"));
         var_1782 = IWindowContainer(find("tile_grid"));
         var_1783 = IWindowContainer(find("now_editing_container"));
         ...
         Util.setProcDirectly(var_1371,onTopTabButton);
         Util.setProcDirectly(var_1372,onObjTabButton);
      }
      ...
      private function refreshPositionGrid() : void
      {
         ...
         var _loc4_:* = null;
         var _loc5_:* = null;
         var _loc1_:IWindowContainer = var_1782;
         _loc1_.visible = true;
      ...
      {
         var _loc1_:IWindowContainer = var_1783;
      ...
      private function populateImgList(param1:IItemListWindow, param2:int) : void
      {
         ...
         while(_loc8_ < _loc6_.length)
         {
            ...
            if(_loc9_ == 0)
            {
               _loc7_ = IWindowContainer(_navigator.windowManager.createWindow("row_" + _loc8_,"",HabboWindowType.const_53,HabboWindowStyle.const_38,HabboWindowParam.const_64,new Rectangle(0,0,param1.width,66)));
