package com.sulake.habbo.ui
{
   ...
   public class MeMenuWidgetHandler implements IRoomWidgetHandler
   {
      ...
      {
         return RoomWidgetEnum.const_340;
      }
      ...
      private function setMeMenuToolbarIcon(param1:Boolean) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            {
               _loc8_ = new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_863,HabboToolbarIconEnum.MEMENU);
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(HabboSessionFigureUpdatedEvent.const_597,onFigureUpdate);
            }
            if(false)
            {
         ...
         if(_container != null && false)
         {
            _container.sessionDataManager.events.addEventListener(HabboSessionFigureUpdatedEvent.const_597,onFigureUpdate);
         }
         var_28 = _container.inventory;
         if(var_28 != null)
         {
            (var_28 as Component).events.addEventListener(HabboInventoryEffectsEvent.const_777,onAvatarEffectsChanged);
            (var_28 as Component).events.addEventListener(HabboInventoryHabboClubEvent.const_700,onHabboClubSubscriptionChanged);
         }
      ...
      {
         var _loc1_:* = [];
         _loc1_.push(RoomWidgetWaveMessage.const_717);
         _loc1_.push(RoomWidgetDanceMessage.const_517);
         _loc1_.push(RoomWidgetGetEffectsMessage.const_648);
         ...
         _loc1_.push(RoomWidgetOpenInventoryMessage.const_523);
         _loc1_.push(RoomWidgetOpenCatalogMessage.const_627);
         _loc1_.push(RoomWidgetStopEffectMessage.const_676);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_1169);
         _loc1_.push(RoomWidgetNavigateToRoomMessage.const_906);
         _loc1_.push(RoomWidgetToolbarMessage.const_552);
         _loc1_.push(RoomWidgetToolbarMessage.const_513);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_615);
         _loc1_.push(RoomWidgetAvatarEditorMessage.const_1247);
         _loc1_.push(RoomWidgetSelectOutfitMessage.const_921);
         _loc1_.push(RoomWidgetShowOwnRoomsMessage.const_520);
         _loc1_.push(RoomWidgetRequestWidgetMessage.const_709);
         _loc1_.push(RoomWidgetRedeemClubPromoMessage.const_560);
         _loc1_.push(RoomWidgetGetSettingsMessage.const_618);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_1172);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_570);
         _loc1_.push(RoomWidgetStoreSettingsMessage.const_573);
         return _loc1_;
      }
      ...
      private function onAvatarEditorClosed(param1:Event = null) : void
      {
         ...
         _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_692));
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetRequestWidgetMessage.const_709:
               ...
               break;
            case RoomWidgetWaveMessage.const_717:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetDanceMessage.const_517:
               if(_container != null && false)
               {
               ...
               break;
            case RoomWidgetGetEffectsMessage.const_648:
               if(var_28 != null)
               {
            ...
            case RoomWidgetSelectEffectMessage.const_578:
               ...
               break;
            case RoomWidgetOpenCatalogMessage.const_627:
               _loc2_ = param1 as RoomWidgetOpenCatalogMessage;
               if(var_81 != null && _loc2_.pageKey == RoomWidgetOpenCatalogMessage.const_503)
               {
                  var_81.openCatalogPage(CatalogPageName.const_315,true);
               }
               break;
            case RoomWidgetOpenInventoryMessage.const_523:
               ...
               if(var_28 != null)
               {
                  ...
                  switch(_loc3_.inventoryType)
                  {
                     case RoomWidgetOpenInventoryMessage.const_944:
                        var_81.openCatalogPage(CatalogPageName.const_1181,true);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_975:
                        var_28.toggleInventoryPage(InventoryCategory.const_254);
                        break;
                     case RoomWidgetOpenInventoryMessage.const_1265:
                        var_28.toggleInventoryPage(InventoryCategory.const_69);
                        break;
            ...
            case RoomWidgetStopEffectMessage.const_676:
               ...
               break;
            case RoomWidgetSetToolbarIconMessage.const_981:
               ...
               break;
            case RoomWidgetNavigateToRoomMessage.const_906:
               ...
               break;
            case RoomWidgetShowOwnRoomsMessage.const_520:
               if(_container != null)
               {
                  _container.navigator.showOwnRooms();
               }
               break;
            case RoomWidgetToolbarMessage.const_552:
               _loc5_ = param1 as RoomWidgetToolbarMessage;
               if(var_204)
               {
                  var_204.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.MEMENU,_loc5_.window));
                  if(var_28 != null)
                  {
                     _loc14_ = false;
                     if(_container != null && false)
            ...
            case RoomWidgetToolbarMessage.const_513:
               ...
               if(var_204)
               {
                  var_204.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_374,HabboToolbarIconEnum.MEMENU,_loc6_.window));
               }
               break;
            case RoomWidgetAvatarEditorMessage.const_615:
               ...
               if(_container)
               {
                  ...
                  if(false && !_loc23_)
                  {
                     ...
                     if(_loc25_ && false)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_421,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_938));
                     }
                     _loc26_ = int(_container.config.getKey("avatar.editor.trial.promo")) > 0;
                     if(_loc26_ && true)
                     {
                        _container.events.dispatchEvent(new RoomWidgetAvatarEditorUpdateEvent(RoomWidgetAvatarEditorUpdateEvent.const_421,_loc24_,RoomWidgetAvatarEditorUpdateEvent.const_1219));
                     }
                  }
               }
               break;
            case RoomWidgetRedeemClubPromoMessage.const_560:
               ...
               break;
            case RoomWidgetGetSettingsMessage.const_618:
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_279,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_570:
               _container.soundManager.volume = (param1 as RoomWidgetStoreSettingsMessage).volume;
               _container.events.dispatchEvent(new RoomWidgetSettingsUpdateEvent(RoomWidgetSettingsUpdateEvent.const_279,_container.soundManager.volume));
               break;
            case RoomWidgetStoreSettingsMessage.const_573:
