package com.sulake.habbo.ui
{
   ...
   public class ChatWidgetHandler implements IRoomWidgetHandler
   {
      ...
      private var var_462:Point = null;
      ...
      {
         return [RoomSessionChatEvent.const_125];
      }
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         switch(param1.type)
         {
            case RoomSessionChatEvent.const_125:
                        ...
                        if(_loc10_ != null)
                        {
                           ...
                           if(_loc13_ == null)
                           {
                              if(false)
                              {
                                 switch(_loc10_.type)
                                 {
                                    case RoomObjectTypeEnum.const_276:
      ...
      {
         return [RoomWidgetChatMessage.const_550,RoomWidgetChatSelectAvatarMessage.const_492];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetChatMessage.const_550:
                     ...
                     if(_loc5_.length > 0)
                     {
                        ...
                        switch(_loc6_.toLowerCase())
                        {
                           ...
                           case ":sign":
                              ...
                              return null;
                           case ":v":
                              _loc10_ = new RoomSessionChatEvent(RoomSessionChatEvent.const_125,_container.roomSession,0,"Version 23477-23467-200911271553");
                           ...
                           case ":chooser":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_322);
                           ...
                           case ":furni":
                              ...
                              {
                                 _loc4_ = new RoomWidgetRequestWidgetMessage(RoomWidgetRequestWidgetMessage.const_388);
                                 _container.processWidgetMessage(_loc4_);
                              }
                              return null;
                           case ":pickall":
               ...
               break;
            case RoomWidgetChatSelectAvatarMessage.const_492:
      ...
      private function updateWidgetPosition() : void
      {
         ...
         if(_loc4_ != null)
         {
            ...
            if(var_781 > 0)
            {
               _loc5_ = Number(_loc4_.scale / var_781);
            }
            if(var_462 == null)
            {
               var_461.x = 0;
               var_461.y = 0;
               var_461.z = 0;
               var_462 = _loc4_.getScreenPoint(var_461);
               var_781 = _loc4_.scale - 10;
            }
            _loc6_ = "";
            _loc7_ = null;
            var_461.x = 0;
            var_461.y = 0;
            var_461.z = 0;
            _loc8_ = _loc4_.getScreenPoint(var_461);
            if(_loc8_ != null)
            {
               if(_loc8_.x != var_462.x || _loc8_.y != var_462.y)
               {
                  _loc9_ = PointMath.sub(_loc8_,PointMath.mul(var_462,_loc5_));
