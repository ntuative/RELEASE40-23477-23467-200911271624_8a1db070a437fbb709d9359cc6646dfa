package com.sulake.habbo.ui
{
   ...
   public class FurnitureEcotronBoxWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_720,RoomWidgetEcotronBoxOpenMessage.const_664,RoomWidgetEcotronBoxOpenedMessage.const_1334];
      }
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_720:
               ...
               break;
            case RoomWidgetEcotronBoxOpenMessage.const_664:
