package com.sulake.habbo.ui
{
   ...
   public class FurniturePresentWidgetHandler implements IRoomWidgetHandler, IGetImageListener
   {
      ...
      {
         return [RoomWidgetFurniToWidgetMessage.const_591,RoomWidgetPresentOpenMessage.const_542,RoomWidgetPresentOpenedMessage.const_1281];
      }
                  ...
                  if(_loc2_ != null)
                  {
                     ...
                     switch(_loc2_.itemType)
                     {
                        case ProductTypeEnum.const_135:
                           ...
                           {
                              _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_456,0,_container.localization.getKey("inventory.furni.item.wallpaper.name"),false,null);
                           }
                           else
                           {
                        ...
                        case ProductTypeEnum.const_686:
                           _loc5_ = new RoomWidgetPresentDataUpdateEvent(RoomWidgetPresentDataUpdateEvent.const_452,0,_container.localization.getKey("widget.furni.present.hc"),false,null);
                           break;
                        default:
         ...
         switch(param1.type)
         {
            case RoomWidgetFurniToWidgetMessage.const_591:
               ...
               if(_loc3_ != null)
               {
                  ...
                  {
                     var_155 = _loc2_.id;
                     _loc6_ = _loc5_.getString(RoomObjectVariableEnum.const_128);
                     if(_loc6_ == null)
                     {
                        _loc6_ = "";
                     }
               ...
               break;
            case RoomWidgetPresentOpenMessage.const_542:
