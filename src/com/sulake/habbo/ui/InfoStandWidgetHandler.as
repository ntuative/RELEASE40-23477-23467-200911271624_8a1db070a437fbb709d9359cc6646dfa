   ...
   public class InfoStandWidgetHandler implements IRoomWidgetHandler
   {
      ...
      public function set container(param1:IRoomWidgetHandlerContainer) : void
      {
         if(_container != null)
         {
            if(false)
            {
               _container.sessionDataManager.events.removeEventListener(UserTagsReceivedEvent.const_133,onUserTags);
               _container.sessionDataManager.events.removeEventListener(BadgeImageReadyEvent.const_159,onBadgeImage);
            }
            if(false)
            {
               _container.roomSessionManager.events.removeEventListener(RoomSessionUserFigureUpdateEvent.const_137,onFigureUpdate);
               _container.roomSessionManager.events.removeEventListener(RoomSessionPetInfoUpdateEvent.const_142,onPetInfo);
               _container.roomSessionManager.events.removeEventListener(RoomSessionPetCommandsUpdateEvent.const_130,onPetCommands);
            }
         }
         _container = param1;
         if(param1 == null)
         ...
         if(false)
         {
            _container.sessionDataManager.events.addEventListener(UserTagsReceivedEvent.const_133,onUserTags);
            _container.sessionDataManager.events.addEventListener(BadgeImageReadyEvent.const_159,onBadgeImage);
         }
         if(false)
         {
            _container.roomSessionManager.events.addEventListener(RoomSessionUserFigureUpdateEvent.const_137,onFigureUpdate);
            _container.roomSessionManager.events.addEventListener(RoomSessionPetInfoUpdateEvent.const_142,onPetInfo);
            _container.roomSessionManager.events.addEventListener(RoomSessionPetCommandsUpdateEvent.const_130,onPetCommands);
         }
      }
      ...
      private function handleGetObjectInfoMessage(param1:RoomWidgetRoomObjectMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.category)
         {
            ...
            case RoomObjectCategoryEnum.const_29:
               ...
               _loc6_ = new RoomWidgetFurniInfoUpdateEvent(RoomWidgetFurniInfoUpdateEvent.const_588);
               _loc6_.id = param1.id;
               ...
               {
                  _loc20_ = _loc7_.getModel().getNumber(RoomObjectVariableEnum.const_311);
            ...
            case RoomObjectCategoryEnum.const_35:
               ...
               if(_loc9_.type == RoomObjectTypeEnum.const_276)
               {
                  _container.roomSession.userDataManager.requestPetInfo(_loc9_.webID);
                  return null;
               }
               if(_loc9_.type == RoomObjectTypeEnum.const_398)
               {
                  _loc10_ = "null";
               ...
               if(_loc14_ != null)
               {
                  _loc11_.carryItem = _loc14_.getModel().getNumber(RoomObjectVariableEnum.const_528);
               }
               if(_loc10_ == RoomWidgetUserInfoUpdateEvent.const_216)
               {
               ...
               if(_loc10_ == RoomWidgetUserInfoUpdateEvent.const_213)
               {
                  ...
                  if(_loc14_ != null)
                  {
                     _loc28_ = _loc14_.getModel().getString(RoomObjectVariableEnum.const_607);
                  ...
                  _loc11_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_1274;
                  if(!_loc23_)
                  {
                  ...
                  if(!_loc24_)
                  {
                     _loc11_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_827;
                  }
                  if(!_loc25_)
                  {
                     _loc11_.canTradeReason = RoomWidgetUserInfoUpdateEvent.const_896;
                  }
               ...
               if(_loc10_ == RoomWidgetUserInfoUpdateEvent.BOT)
               {
                  ...
                  _loc12_.push(RoomWidgetUserInfoUpdateEvent.const_1332);
               }
               else
               {
      ...
      private function onPetInfo(param1:RoomSessionPetInfoUpdateEvent) : void
      {
         ...
         var _loc5_:IAvatarImage = var_536.getValue(_loc2_.petId) as IAvatarImage;
         if(_loc5_ == null)
         {
            _loc5_ = _container.avatarRenderManager.createPetImage(_loc4_,AvatarScaleType.const_50);
            var_536.add(_loc2_.petId,_loc5_);
         }
      ...
      public function getWidgetMessages() : Array
      {
         ...
         _loc1_.push(RoomWidgetUserActionMessage.const_359);
         ...
         _loc1_.push(RoomWidgetFurniActionMessage.const_221);
         _loc1_.push(RoomWidgetFurniActionMessage.const_553);
         _loc1_.push(RoomWidgetFurniActionMessage.const_614);
         _loc1_.push(RoomWidgetRoomTagSearchMessage.const_506);
         _loc1_.push(RoomWidgetGetBadgeDetailsMessage.const_599);
         ...
         _loc1_.push(RoomWidgetPetCommandMessage.const_693);
      ...
      public function dispose() : void
      {
         ...
         if(var_536 != null)
         {
            _loc1_ = var_536.getKeys();
            for each(_loc2_ in _loc1_)
            {
               _loc3_ = var_536.getValue(_loc2_);
               _loc3_.dispose();
               _loc3_ = null;
            }
            var_536 = null;
      ...
      public function processWidgetMessage(param1:RoomWidgetMessage) : RoomWidgetUpdateEvent
      {
         ...
         switch(param1.type)
         {
            ...
            case RoomWidgetUserActionMessage.const_689:
               _loc8_ = new RoomWidgetChatInputContentUpdateEvent(RoomWidgetChatInputContentUpdateEvent.const_788,_loc3_.name);
            ...
            case RoomWidgetUserActionMessage.const_571:
               ...
               break;
            case RoomWidgetUserActionMessage.const_359:
            ...
            case RoomWidgetUserActionMessage.const_582:
               ...
               break;
            case RoomWidgetRoomTagSearchMessage.const_506:
               ...
               break;
            case RoomWidgetGetBadgeDetailsMessage.const_599:
            ...
            case RoomWidgetUserActionMessage.const_558:
               ...
               break;
            case RoomWidgetPetCommandMessage.const_693:
