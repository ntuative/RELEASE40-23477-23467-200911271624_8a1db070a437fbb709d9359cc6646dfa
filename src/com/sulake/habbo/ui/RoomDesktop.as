package com.sulake.habbo.ui
{
   ...
   public class RoomDesktop implements IRoomDesktop, IRoomWidgetMessageListener, IRoomWidgetHandlerContainer
   {
      ...
      private var var_224:DesktopLayoutManager;
      ...
      private var var_1889:IHabboHelp = null;
      ...
      private var var_778:IRoomWidgetFactory = null;
      ...
      private var var_1088:IAvatarRenderManager = null;
      ...
      private var var_562:ISessionDataManager = null;
      
      private var var_1955:uint = 16777215;
      ...
      public function RoomDesktop(param1:IRoomSession, param2:IAssetLibrary, param3:IConnection)
      {
         ...
         _widgets = new Map();
         var_225 = new Map();
         var_224 = new DesktopLayoutManager();
      }
      ...
      public function set roomEngine(param1:IRoomEngine) : void
      {
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.addEventListener(RoomContentLoadedEvent.const_416,onRoomContentLoaded);
      ...
      public function init() : void
      {
         ...
         {
            var_657 = _roomEngine.loadRoomResources(var_47.roomResources);
            if(false)
            {
               var_9 = false;
         ...
         if(var_459 != null && true)
         {
            var_1235 = !var_459.showInterstitial();
         }
         checkInterrupts();
      }
      ...
      private function onRoomViewResized(param1:WindowEvent) : void
      {
         ...
         _roomEngine.modifyRoomCanvas(var_47.roomId,var_47.roomCategory,var_261[0],_loc2_.width,_loc2_.height);
      ...
      public function dispose() : void
      {
         ...
         if(var_225 != null)
         {
            ...
            {
               _loc5_ = var_225.getWithIndex(_loc1_) as IRoomWidgetHandler;
               if(_loc5_ != null)
               {
                  _loc5_.dispose();
               }
         ...
         if(_roomEngine != null && false)
         {
            ...
            _roomEngine.events.removeEventListener(RoomContentLoadedEvent.const_416,onRoomContentLoaded);
      ...
      private function resizeColorizer(param1:WindowEvent) : void
      {
         ...
         _loc3_.graphics.beginFill(var_1955);
      ...
      private function updateHandlers() : void
      {
         ...
         while(_loc1_ < var_225.length)
         {
            _loc2_ = var_225.getWithIndex(_loc1_) as IRoomWidgetHandler;
            if(_loc2_ != null)
            {
               _loc2_.update();
            }
      ...
      {
         var_224.setLayout(param1,_windowManager);
         if(var_204 != null)
         {
            var_224.toolbarSize = var_204.size;
            var_224.toolbarOrientation = var_204.orientation;
         }
      }
      ...
      public function createWidget(param1:String) : void
      {
         ...
         _loc2_ = var_778.createWidget(param1);
         if(_loc2_ == null)
         {
            return;
         }
         ...
         var_224.addWidgetWindow(_loc2_.mainWindow);
         ...
         if(_loc3_ != null)
         {
            ...
            if(!var_225.add(param1,_loc3_))
            {
               _loc3_.dispose();
            }
         }
         param1 = "null";
         var _loc4_:RoomWidgetRoomViewUpdateEvent = new RoomWidgetRoomViewUpdateEvent(param1,var_224.roomViewRect);
      ...
      private function onToolbarRepositionEvent(param1:HabboToolbarEvent) : void
      {
         if(var_224 != null)
         {
            var_224.toolbarOrientation = param1.orientation;
         }
      }
      ...
      public function roomObjectEventHandler(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_616:
               ...
               if(var_1419 != null && _loc3_ == RoomObjectCategoryEnum.const_35)
               {
                  _loc7_ = var_47.userDataManager.getUserDataByIndex(_loc2_);
                  if(_loc7_ != null && _loc7_.type == RoomObjectTypeEnum.const_398)
                  {
            ...
            case RoomEngineObjectEvent.const_106:
               _loc5_ = new RoomWidgetFurniToWidgetMessage(RoomWidgetFurniToWidgetMessage.const_488,_loc2_,_loc3_,param1.roomId,param1.roomCategory);
               processWidgetMessage(_loc5_);
               break;
      ...
      public function processEvent(param1:Event) : void
      {
         ...
         while(_loc2_ >= 0)
         {
            _loc3_ = var_225.getWithIndex(_loc2_) as IRoomWidgetHandler;
            if(_loc3_ != null)
            {
      ...
      public function createRoomView(param1:int) : void
      {
         ...
         var _loc20_:* = null;
         var _loc2_:Rectangle = var_224.roomViewRect;
         ...
         if(_loc7_ != null)
         {
            _loc12_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_524);
            _loc13_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_690);
            _loc14_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_516);
            _loc15_ = _roomEngine.getRoomNumberValue(var_47.roomId,var_47.roomCategory,RoomVariableEnum.const_538);
      ...
      private function handleRoomAdClick(param1:RoomEngineObjectEvent) : void
      {
         ...
         var _loc4_:String = _loc3_.getString(RoomObjectVariableEnum.const_209);
      ...
      private function handleRoomAdTooltip(param1:RoomEngineObjectEvent) : void
      {
         ...
         switch(param1.type)
         {
            case RoomEngineObjectEvent.const_385:
               ...
               var_177 = _windowManager.createWindow("room_ad_tooltip","${ads.roomad.tooltip}",WindowType.WINDOW_TYPE_TOOLTIP,WindowStyle.const_247,WindowParam.const_78) as IToolTipWindow;
      ...
      {
         if(var_657 == null || false)
         {
            return;
         }
         var _loc2_:int = var_657.indexOf(param1.contentType);
         if(_loc2_ != -1)
         {
            var_657.splice(_loc2_,1);
         }
         if(false)
         {
            var_9 = true;
      ...
      {
         if(var_34 != null && var_47 != null && var_1235 && var_9)
         {
            var_34.startSession(var_47);
            processEvent(new RoomWidgetLoadingBarUpdateEvent(RoomWidgetLoadingBarUpdateEvent.const_242));
         }
      }
      ...
      {
         var _loc3_:IWindowContainer = var_224.getRoomView() as IWindowContainer;
         if(_loc3_ == null)
         {
            return;
         }
