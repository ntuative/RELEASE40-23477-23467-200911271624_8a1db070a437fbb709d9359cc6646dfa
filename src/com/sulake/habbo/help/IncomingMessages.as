package com.sulake.habbo.help
{
   ...
   public class IncomingMessages
   {
      ...
      private function onFaqText(param1:IMessageEvent) : void
      {
         ...
         if(_loc4_ != null)
         {
            var_41.tellUI(HabboHelpViewEnum.const_186,_loc4_);
         }
      }
      ...
      private function onFaqCategory(param1:IMessageEvent) : void
      {
         ...
         var_41.tellUI(HabboHelpViewEnum.const_241,_loc6_);
      }
      ...
      private function onFaqClientFaqs(param1:IMessageEvent) : void
      {
         ...
         var_41.tellUI(HabboHelpViewEnum.const_127);
      }
      ...
      {
         var_41.showUI(HabboHelpViewEnum.const_278);
      }
      ...
      private function onFaqCategories(param1:IMessageEvent) : void
      {
         ...
         var_41.showUI(HabboHelpViewEnum.const_415);
      }
      ...
      private function onFaqSearchResults(param1:IMessageEvent) : void
      {
         ...
         var_41.showUI(HabboHelpViewEnum.const_518);
         var_41.tellUI(HabboHelpViewEnum.const_518,_loc5_);
      }
      ...
      private function onUsers(param1:IMessageEvent) : void
      {
         ...
         while(_loc4_ < _loc3_.getUserCount())
         {
            ...
            if(_loc5_.webID != _userId && _loc5_.userType == RoomObjectTypeEnum.const_398)
            {
         ...
         var_41.tellUI(HabboHelpViewEnum.const_647);
      }
