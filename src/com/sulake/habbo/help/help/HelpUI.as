package com.sulake.habbo.help.help
{
   ...
   public class HelpUI
   {
      ...
      private var var_1872:String = "HHVE_HELP_FRONTPAGE";
      ...
      public function HelpUI(param1:HabboHelp, param2:IAssetLibrary, param3:IHabboWindowManager, param4:IHabboLocalizationManager, param5:IHabboToolbar)
      {
         ...
         _windowManager.registerLocalizationParameter("info.client.version","version","23477-23467-200911271553");
         var_204 = param5;
         var_120 = new Map();
         var_120.add(HabboHelpViewEnum.const_1147,IHelpViewController(new PlaceholderView(this,_windowManager,_assetLibrary)));
         var_120.add(HabboHelpViewEnum.const_127,IHelpViewController(new HelpMainView(this,_windowManager,_assetLibrary)));
         var_120.add(HabboHelpViewEnum.const_415,IHelpViewController(new FaqBrowseTopView(this,_windowManager,_assetLibrary)));
         var_120.add(HabboHelpViewEnum.const_241,IHelpViewController(new FaqBrowseCategoryView(this,_windowManager,_assetLibrary)));
         var_120.add(HabboHelpViewEnum.const_186,IHelpViewController(new FaqBrowseEntry(this,_windowManager,_assetLibrary)));
         var_120.add(HabboHelpViewEnum.const_518,IHelpViewController(new FaqBrowseSearchResults(this,_windowManager,_assetLibrary)));
         var_120.add(HabboHelpViewEnum.const_278,IHelpViewController(new CallForHelpTopicSelection(this,_windowManager,_assetLibrary)));
         var_120.add(HabboHelpViewEnum.const_548,IHelpViewController(new CallForHelpTextInput(this,_windowManager,_assetLibrary)));
         var_120.add(HabboHelpViewEnum.const_197,IHelpViewController(new CallForHelpSentView(this,_windowManager,_assetLibrary)));
         var_120.add(HabboHelpViewEnum.CALL_FOR_HELP_PENDING_ITEM,IHelpViewController(new CallForHelpPendingItemView(this,_windowManager,_assetLibrary)));
         var_120.add(HabboHelpViewEnum.const_647,IHelpViewController(new CallForHelpReportUserSelection(this,_windowManager,_assetLibrary)));
      }
      ...
      private function addBackButtonWindow() : void
      {
         var _loc2_:* = null;
         var _loc3_:* = null;
         if(var_254 == HabboHelpViewEnum.const_127 || false)
         {
            return;
         }
         if(var_387 == null)
         {
            ...
            var_387 = _loc2_.buildFromXML(XML(_loc3_.content)) as IWindowContainer;
         }
         var _loc1_:IItemListWindow = _window.findChildByName("content_list") as IItemListWindow;
         if(_loc1_ == null || var_387 == null)
         {
            return;
         }
         if(_loc1_.getListItemIndex(var_387 as IWindow) > -1)
         {
            return;
         }
         _loc1_.addListItem(var_387 as IWindow);
      ...
      {
         return var_120.getValue(var_254);
      }
      ...
      public function dispose() : void
      {
         var _loc3_:* = null;
         var _loc4_:* = null;
         var _loc1_:Array = var_120.getKeys();
         var _loc2_:int = 0;
         while(_loc2_ < _loc1_.length)
         {
            _loc3_ = _loc1_[_loc2_];
            _loc4_ = var_120.getValue(_loc3_) as IHelpViewController;
            if(_loc4_ != null)
            {
               _loc4_.dispose();
            }
      ...
      {
         var_1871 = param1;
         var _loc2_:IHelpViewController = var_120.getValue(HabboHelpViewEnum.const_127) as IHelpViewController;
      ...
      public function showCallForHelpResult(param1:String) : void
      {
         switch(param1)
         {
            case CallForHelpResultEnum.const_197:
               showUI(HabboHelpViewEnum.const_197);
               break;
      ...
      {
         var _loc3_:* = null;
         if(var_254 == HabboHelpViewEnum.const_127)
         {
            return;
         }
         if(true)
         ...
         var _loc2_:IBitmapWrapperWindow = var_387.findChildByName("back_image") as IBitmapWrapperWindow;
         if(_loc2_ == null)
         {
            return;
         }
      ...
      public function updateWindowDimensions() : void
      {
         ...
         _window.height = _loc1_.height + var_1407;
         _window.width = _loc1_.width + var_1406;
      }
      ...
      public function setRoomSessionStatus(param1:Boolean) : void
      {
         ...
         {
            _loc3_ = var_120.getWithIndex(_loc2_) as IHelpViewController;
            if(_loc3_ != null)
            {
      ...
      public function showUI(param1:String = null, param2:Boolean = true) : void
      {
         ...
         if(_loc3_)
         {
            if(var_204 != null)
            {
               var_204.events.dispatchEvent(new HabboToolbarShowMenuEvent(HabboToolbarShowMenuEvent.const_48,HabboToolbarIconEnum.HELP,_window));
            }
         }
      ...
      public function handleCallGuideBot() : void
      {
         ...
         hideUI();
         var_41.events.dispatchEvent(new HabboHelpTutorialEvent(HabboHelpTutorialEvent.const_525));
      }
