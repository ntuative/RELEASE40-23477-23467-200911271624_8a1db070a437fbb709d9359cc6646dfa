package com.sulake.habbo.help.help.data
{
   ...
   public class FaqIndex
   {
      ...
      private var var_645:FaqCategory;
      ...
      public function FaqIndex()
      {
         ...
         var_645 = new FaqCategory(-99999,"${help.faq.title.searchresults}");
         var_136 = new Map();
      }
      ...
      public function storeAnswerText(param1:int, param2:String) : void
      {
         ...
         if(var_645.hasItem(param1))
         {
            var_645.getItem(param1).answerText = param2;
         }
         var _loc3_:int = 0;
