package com.sulake.habbo.room
{
   ...
   public class RoomContentLoader implements IRoomContentLoader, IDisposable
   {
      ...
      private static const const_734:String = "tile_cursor";
      
      private static const const_270:String = "RCL_PUBLICROOM_";
      
      private static const const_477:String = "wall_place_holder";
      
      private static const const_1016:int = 2;
      
      private static const const_333:String = "place_holder";
      
      private static const const_1017:String = const_333;
      ...
      public static const const_511:String = "RCL_LOADER_READY";
      ...
      private var var_928:IEventDispatcher = null;
      ...
      public function RoomContentLoader()
      {
         var_627 = [];
         var_626 = [];
         var_1800 = ["hh_people_pool","hh_people_pool_calippo","hh_paalu","hh_people_paalu"];
         var_1796 = ["room_public","room_public_park","room_public_pool"];
         super();
         var_375 = new Map();
         _events = new Map();
      ...
      {
         var _loc2_:String = var_521.getValue(param1) as String;
                     ...
                     if(_loc8_.length > 0)
                     {
                        ...
                        if(_loc9_.length >= 3)
                        {
                           ...
                           if(_loc9_[0] as String == "s")
                           {
                              ...
                              if(var_627.indexOf(_loc14_) < 0)
                              {
                                 var_627.push(_loc14_);
                              }
                           }
                           else if(_loc9_[0] as String == "i")
                           {
                              ...
                              var_521.add(_loc10_,_loc11_);
                              if(var_626.indexOf(_loc14_) < 0)
                              {
                                 var_626.push(_loc14_);
                              }
                           }
                           _loc16_ = var_446.getValue(_loc14_);
                           if(_loc12_ > _loc16_)
                           {
                              var_446.remove(_loc14_);
                              var_446.add(_loc14_,_loc12_);
                           }
                        }
                     }
                  }
      ...
      {
         return [const_333,const_477,ROOM_CONTENT,const_734,const_736];
      }
      ...
      private function getAssetLibrary(param1:String) : IAssetLibrary
      {
         ...
         if(_loc3_ == null)
         {
            _loc4_ = var_520.getValue(_loc2_);
            if(_loc4_ != null)
            {
      ...
      private function getObjectRevision(param1:String) : int
      {
         ...
         if(_loc2_ == RoomObjectCategoryEnum.OBJECT_CATEGORY_FURNITURE || _loc2_ == RoomObjectCategoryEnum.const_29)
         {
            ...
            return int(var_446.getValue(param1));
         }
         return 0;
      }
      ...
      public function loadLegacyContent(param1:String, param2:IEventDispatcher) : Array
      {
         ...
         while(_loc5_ < _loc3_.length)
         {
            if(_loc3_[_loc5_].toString().length > 0 && var_1800.indexOf(_loc3_[_loc5_]) == -1)
            {
      ...
      public function getLogicType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectLogicEnum.const_166 && _loc5_ != RoomObjectLogicEnum.const_102)
         {
            _loc6_ = "@shadow";
      ...
      {
         if(var_627.indexOf(param1) >= 0)
         {
            return const_333;
         }
         if(var_626.indexOf(param1) >= 0)
         {
            return const_477;
         }
      ...
      private function getRoomObjectAlias(param1:String) : String
      {
         ...
         if(var_373 != null)
         {
            _loc2_ = var_373.getValue(param1) as String;
         }
         if(_loc2_ == null)
         {
            _loc2_ = param1;
      ...
      private function onContentLoadError(param1:Event) : void
      {
         ...
         for each(_loc4_ in _loc3_)
         {
            ...
            {
               Core.crash("Failed to load asset: " + _loc2_.url,CoreComponent.const_1337);
               return;
            }
         }
      }
      ...
      {
         var _loc3_:String = var_521.getValue(param1) as String;
      ...
      private function onContentLoaded(param1:Event) : void
      {
         ...
         if(_loc4_)
         {
            if(var_1796.indexOf(getVisualizationType(_loc5_)) >= 0)
            {
      ...
      public function getObjectCategory(param1:String) : int
      {
         ...
         if(var_170 != null && (var_170.type == param1 || var_170.hasWorldType(param1)))
         {
            return RoomObjectCategoryEnum.const_51;
         }
         if(param1 == "room")
         {
            return RoomObjectCategoryEnum.const_51;
      ...
      private function continueInitilization() : void
      {
         if(var_1795)
         {
            ...
            if(var_928 != null)
            {
               var_928.dispatchEvent(new Event(const_511));
            }
         }
      }
      ...
      public function initialize(param1:IEventDispatcher, param2:IHabboConfigurationManager) : void
      {
         ...
         if(_assetLibrary != null && param2 != null)
         {
            ...
            var_928 = param1;
            var_1797 = param2.getKey("flash.dynamic.download.url","furniture/");
            var_1794 = param2.getKey("flash.dynamic.download.name.template","%typeid%.swf");
            var_1799 = param2.getKey("public.room.dynamic.download.url","");
            var_1798 = param2.getKey("public.room.dynamic.download.name.template","%typeid%.swf");
         }
         _state = const_735;
      }
      ...
      public function getVisualizationType(param1:String) : String
      {
         ...
         if(_loc5_ != RoomObjectVisualizationEnum.const_166 && _loc5_ != RoomObjectVisualizationEnum.const_102)
         {
            _loc6_ = "@shadow";
            if(param1.indexOf(_loc6_) > -1)
            {
      ...
      {
         if(getObjectCategory(const_270 + param1) == RoomObjectCategoryEnum.const_51)
         {
            return true;
         }
         return false;
      ...
      public function loadObjectContent(param1:String, param2:IEventDispatcher) : Boolean
      {
         ...
         {
            _loc4_.addEventListener(AssetLibrary.const_372,onContentLoaded);
            _loc6_ = 0;
