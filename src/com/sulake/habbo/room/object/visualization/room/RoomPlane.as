package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomPlane
   {
      ...
      private var var_665:IPlaneRasterizer = null;
      ...
      private var var_496:PlaneMaskManager = null;
      ...
      private var var_1459:Boolean = true;
      ...
      private function draw(param1:BitmapData, param2:Matrix) : void
      {
         ...
         if(_bitmapData != null)
         {
            if(param2.a == 1 && param2.d == 1 && param2.c == 0 && param2.b != 0 && Math.abs(param2.b) <= 1 && (_type == const_245 || _type == const_172))
            {
               _loc3_ = 0;
               _loc4_ = 0;
               _loc5_ = 0;
      ...
      private function updateMask(param1:BitmapData, param2:IRoomGeometry) : void
      {
         ...
         var _loc13_:int = 0;
         var _loc14_:int = 0;
         if(!var_814 || false && false && !var_156 || var_496 == null)
         {
            return;
         }
         ...
         if(var_156)
         {
            ...
            while(_loc5_ < var_202.length)
            {
               ...
               if(_loc3_ != null)
               {
                  ...
                  _loc12_ = _loc3_.type;
                  var_496.updateMask(var_63,_loc12_,param2.scale,_loc9_,_loc10_,_loc11_);
                  var_664.push(new RoomPlaneBitmapMask(_loc12_,_loc3_.leftSideLoc,_loc3_.rightSideLoc));
               }
               _loc5_++;
            }
            _loc6_ = 0;
            while(_loc6_ < var_263.length)
            {
               _loc4_ = var_263[_loc6_] as RoomPlaneRectangleMask;
               if(_loc4_ != null)
               {
                  ...
                  var_987.push(new RoomPlaneRectangleMask(_loc4_.leftSideLength,_loc4_.rightSideLoc,_loc4_.leftSideLength,_loc4_.rightSideLength));
               }
               _loc6_++;
            }
            var_156 = false;
      ...
      private function getTextureIdentifier(param1:IRoomGeometry) : String
      {
         ...
         if(var_665 != null)
         {
            _loc2_ = var_665.getTextureIdentifier(param1.scale,normal);
         }
         return _loc2_;
      }
      ...
      private function renderTexture(param1:IRoomGeometry, param2:BitmapData) : void
      {
         ...
         if(_type == const_245 || _type == const_172)
         {
         ...
         if(true)
         {
            while(_loc1_ < var_202.length)
            {
               ...
               if(_loc4_ != null)
               {
                  ...
                  {
                     _loc7_ = var_664[_loc2_] as RoomPlaneBitmapMask;
                     if(_loc7_ != null)
                     {
      ...
      public function update(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         var _loc10_:* = null;
         if(param1 == null || var_666 == null || var_78 == null || var_249 == null || var_250 == null || var_400 == null)
         {
            return false;
         }
         ...
         if(param1.updateId != var_1157)
         {
            ...
            if(_loc4_ != null && (_loc4_.x != var_926 || _loc4_.y != var_1793 || _loc4_.z != var_1791 || param1.scale != var_1792))
            {
               ...
               _loc6_ = 0;
               while(_loc6_ < var_1047.length)
               {
                  _loc5_ = Number(Vector3d.cosAngle(param1.directionAxis,var_1047[_loc6_]));
                  if(_loc5_ > -0.001)
                  {
                     if(_isVisible)
                     {
               ...
               _loc7_ = param1.getScreenPosition(var_666);
               _loc8_ = _loc7_.z;
      ...
      private function needsNewTexture(param1:IRoomGeometry, param2:int) : Boolean
      {
         ...
         {
            updateMaskChangeStatus();
            if(_loc4_ == null || _loc4_.timeStamp >= 0 && param2 > _loc4_.timeStamp || var_156)
            {
               return true;
            }
         }
      ...
      public function addRectangleMask(param1:Number, param2:Number, param3:Number, param4:Number) : Boolean
      {
         ...
         if(var_814)
         {
            ...
            while(_loc6_ < var_263.length)
            {
               _loc5_ = var_263[_loc6_] as RoomPlaneRectangleMask;
               if(_loc5_ != null)
               {
      ...
      private function getTexture(param1:IRoomGeometry, param2:int) : BitmapData
      {
         ...
         if(needsNewTexture(param1,param2))
         {
            ...
            if(var_665 != null)
            {
               _loc4_ = var_665.render(_loc8_,_id,_loc5_,_loc6_,param1.scale,_loc7_,var_1459,var_2011,var_2012,var_2008,var_2009,param2);
               if(_loc4_ != null)
               {
