package com.sulake.habbo.room.object.visualization.room.utils
{
   public class Randomizer
   {
      ...
      public static const const_1481:int = 16777216;
      
      public static const const_1375:int = 1;
       
      
      private var var_2211:int = 69069;
      
      private var var_1200:int = 1;
      
      private var var_2212:int = 5;
      
      private var var_1434:int = 16777216;
      ...
      private function iterateScaled(param1:int, param2:int) : int
      {
         ...
         return int(param1 + _loc3_ / var_1434 * param2);
      }
      ...
      {
         var _loc1_:int = var_2211 * var_1200 + var_2212;
         if(_loc1_ < 0)
         {
            _loc1_ = -_loc1_;
         }
