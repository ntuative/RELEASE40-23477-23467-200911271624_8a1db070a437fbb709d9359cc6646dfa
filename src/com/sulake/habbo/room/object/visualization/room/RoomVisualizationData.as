package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualizationData implements IRoomObjectVisualizationData
   {
      ...
      private var var_496:PlaneMaskManager;
      
      private var var_495:WallRasterizer;
      ...
      {
         super();
         var_495 = new WallRasterizer();
         var_494 = new FloorRasterizer();
         _landscapeRasterizer = new LandscapeRasterizer();
         var_496 = new PlaneMaskManager();
      }
      ...
      public function initialize(param1:XML) : Boolean
      {
         ...
         {
            _loc6_ = _loc2_[0];
            var_495.initialize(_loc6_);
         }
         var _loc3_:XMLList = param1.floorData;
         if(_loc3_.length() > 0)
         {
            _loc7_ = _loc3_[0];
            var_494.initialize(_loc7_);
         }
      ...
      public function initializeAssetCollection(param1:IGraphicAssetCollection) : void
      {
         ...
         var_496.initializeAssetCollection(param1);
         var_811 = true;
      }
