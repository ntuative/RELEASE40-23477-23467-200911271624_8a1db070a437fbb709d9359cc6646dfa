package com.sulake.habbo.room.object.visualization.room
{
   ...
   public class RoomVisualization extends RoomObjectSpriteVisualization
   {
      ...
      public static const const_1189:int = 13421772;
      
      private static const const_1080:int = 16777215;
      
      public static const const_1330:int = 10066329;
      
      private static const const_1081:int = 13421772;
      
      public static const const_1144:int = 16777215;
      
      private static const const_1373:int = 0;
      
      public static const const_1203:int = 16777215;
      
      private static const const_1082:int = 10066329;
      
      private static const const_1083:int = 10066329;
      
      public static const const_1134:int = 13421772;
      ...
      private var var_2109:String = null;
      ...
      protected function updatePlanes(param1:IRoomGeometry) : void
      {
         ...
         while(_loc4_ < var_107.length)
         {
            ...
            if(_loc9_ != null)
            {
               ...
               if(_loc5_)
               {
                  _loc9_.assetName = _loc6_ + "_" + var_1338;
               }
               if(var_86.getPlaneType(_loc4_) == RoomPlaneData.const_141)
               {
      ...
      private function getLandscapeWidth() : Number
      {
         ...
         while(_loc2_ < var_86.planeCount)
         {
            ...
            if(_loc3_ == RoomPlaneData.const_223)
            {
      ...
      protected function defineSprites() : void
      {
         ...
         while(_loc2_ < _loc1_)
         {
            ...
            {
               if(_loc3_.type == RoomPlane.const_245 && (_loc3_.leftSide.length < 1 || _loc3_.rightSide.length < 1))
               {
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         {
            _loc5_ = _loc3_.getString(RoomObjectVariableEnum.const_719);
            _loc6_ = _loc3_.getString(RoomObjectVariableEnum.const_544);
            _loc7_ = _loc3_.getString(RoomObjectVariableEnum.const_535);
            updatePlaneTextureTypes(_loc6_,_loc5_,_loc7_);
            _loc8_ = _loc3_.getString(RoomObjectVariableEnum.const_780);
            if(_loc8_ != var_2109)
            {
               updatePlaneMasks(_loc8_);
               var_2109 = _loc8_;
            }
            _loc9_ = uint(_loc3_.getNumber(RoomObjectVariableEnum.const_638));
            if(_loc9_ != var_1014)
            {
               var_1014 = _loc9_;
            }
            var_2110 = Boolean(_loc3_.getNumber(RoomObjectVariableEnum.const_901));
      ...
      protected function initializeRoomPlanes() : void
      {
         ...
         var _loc2_:String = _loc1_.getModel().getString(RoomObjectVariableEnum.const_899);
         ...
         while(_loc7_ < var_86.planeCount)
         {
            ...
            {
               _loc13_ = new RoomPlane(_loc1_.getLocation(),_loc8_,_loc9_,_loc10_,RoomPlane.const_245,true,_loc11_,_loc6_);
               if(_loc9_.length < 1 || _loc10_.length < 1)
               {
                  _loc13_.hasTexture = false;
               }
            ...
            else if(_loc12_ == RoomPlaneData.const_223)
            {
      ...
      protected function updatePlaneTextureTypes(param1:String, param2:String, param3:String) : Boolean
      {
         ...
         while(_loc4_ < var_107.length)
         {
            ...
            if(_loc5_ != null)
            {
               ...
               else if(_loc5_.type == RoomPlane.const_245 && param2 != null)
               {
                  _loc5_.id = param2;
               }
         ...
         while(_loc5_ < _planeMaskParser.maskCount)
         {
            ...
            if(_loc7_ != null)
            {
               ...
               while(_loc9_ < var_107.length)
               {
                  ...
                  if(_loc3_.type == RoomPlane.const_245 || _loc3_.type == RoomPlane.const_172 && _loc8_ == RoomPlaneBitmapMaskData.const_211)
                  {
