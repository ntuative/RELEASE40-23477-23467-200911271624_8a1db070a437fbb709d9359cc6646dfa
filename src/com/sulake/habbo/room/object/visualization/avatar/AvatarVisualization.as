package com.sulake.habbo.room.object.visualization.avatar
{
   ...
   public class AvatarVisualization extends RoomObjectSpriteVisualization
   {
      ...
      private const const_1359:int = 0;
      ...
      private const const_1030:int = 3;
      
      private const const_1552:int = 2;
      
      private var var_772:AvatarVisualizationData = null;
      
      private const const_1031:int = 3;
      ...
      {
         var_772 = param1 as AvatarVisualizationData;
         createSprites(const_1031);
         return true;
      }
      ...
      override public function update(param1:IRoomGeometry = null) : void
      {
         ...
         var _loc9_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_669);
         var _loc10_:Number = _loc3_.getNumber(RoomObjectVariableEnum.const_718);
         ...
         var _loc13_:Number = _loc7_ - var_1192;
         ...
         var _loc19_:Boolean = var_272 != _loc2_.getUpdateID() || var_205 != param1.scale || var_182 != _loc3_.getUpdateID();
         var _loc20_:Boolean = _isAnimating || var_457 > 0;
         if(_loc19_ || _loc20_)
         {
            --var_457;
            _loc22_ = getTimer();
            ...
            if(_loc5_ == null)
            {
               _loc5_ = var_772.getAvatar(_loc6_,param1.scale);
               if(_loc5_ == null)
               {
                  return;
               }
            ...
            if(isNaN(_loc24_) || _loc3_.getString(RoomObjectVariableEnum.const_252) == "float")
            {
               _loc24_ = _loc23_;
            }
            else
            ...
            _loc25_ = _loc3_.getString(RoomObjectVariableEnum.const_252);
            _loc26_ = _loc3_.getString(RoomObjectVariableEnum.const_502);
            _loc5_.appendAction(AvatarAction.const_619,_loc25_,_loc26_);
            _loc27_ = false;
            if(_loc25_ == "lay")
            {
            ...
            _loc28_ = _loc3_.getNumber(RoomObjectVariableEnum.const_346);
            if(_loc28_ > 0 && _loc5_.getScale() == AvatarScaleType.const_50)
            {
               _loc50_ = _loc3_.getNumber(RoomObjectVariableEnum.const_341);
               _loc51_ = 3;
               _loc52_ = _loc7_ - _loc50_;
               if(_loc52_ < _loc51_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_297,AvatarAction.const_1156[_loc28_]);
               }
            }
            _loc29_ = _loc3_.getNumber(RoomObjectVariableEnum.const_826);
            if(_loc29_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_965,_loc29_);
            }
            _loc30_ = _loc3_.getNumber(RoomObjectVariableEnum.const_775);
            if(_loc30_ > 0)
            {
               _loc53_ = _loc3_.getNumber(RoomObjectVariableEnum.const_968);
               _loc54_ = 5;
               _loc55_ = _loc7_ - _loc53_;
               if(_loc55_ < _loc54_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_787,_loc30_);
               }
            }
            _loc31_ = _loc3_.getNumber(RoomObjectVariableEnum.const_528);
            _loc32_ = 0;
            if(_loc31_ > 0)
            {
               _loc56_ = _loc3_.getNumber(RoomObjectVariableEnum.const_530);
               _loc57_ = 100;
               _loc58_ = _loc7_ - _loc56_;
               if(_loc58_ < _loc57_ * 1000)
               {
                  _loc5_.appendAction(AvatarAction.const_869,_loc31_);
                  _loc59_ = 1;
                  while(_loc59_ < 10)
                  {
            ...
            _loc33_ = _loc3_.getNumber(RoomObjectVariableEnum.const_955);
            if(_loc32_ > 0)
            {
               _loc33_ = _loc32_;
            }
            if(_loc33_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_805,_loc33_);
            }
            if(_loc8_)
            {
               _loc5_.appendAction(AvatarAction.const_355);
            }
            _loc34_ = _loc3_.getNumber(RoomObjectVariableEnum.const_364) > 0;
            if(_loc34_ || _loc12_)
            {
               _loc5_.appendAction(AvatarAction.const_715);
            }
            if(_loc14_)
            {
               _loc5_.appendAction(AvatarAction.const_427);
            }
            _loc35_ = _loc3_.getNumber(RoomObjectVariableEnum.const_877);
            if(_loc35_ > 0)
            {
               _loc5_.appendAction(AvatarAction.const_714,_loc35_);
            }
            ...
            if(_loc3_.getNumber(RoomObjectVariableEnum.const_857))
            {
               _loc42_.visible = true;
               _loc39_ = null;
               _loc38_ = null;
               ...
               if(_loc38_ != null)
               {
                  _loc39_ = var_772.getAvatarRendererAsset(_loc38_) as BitmapDataAsset;
               }
               if(_loc39_ != null)
               {
                  _loc42_.asset = _loc39_;
            ...
            var_272 = _loc2_.getUpdateID();
            var_182 = _loc3_.getUpdateID();
            var_205 = param1.scale;
            var_771.push(getTimer() - _loc22_);
            if(false)
            {
               _loc76_ = 0;
               _loc77_ = "[";
               for each(_loc78_ in var_771)
               {
                  _loc76_ += _loc78_;
                  _loc77_ += "," + _loc78_;
               }
