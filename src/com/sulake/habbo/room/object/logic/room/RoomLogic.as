package com.sulake.habbo.room.object.logic.room
{
   ...
   public class RoomLogic extends ObjectLogicBase
   {
      ...
      private var var_1438:int = 1500;
      
      private var var_1439:int = 255;
      
      private var var_1437:int = 255;
      
      private var var_1206:uint = 16777215;
      
      private var var_973:uint = 16777215;
      
      protected var var_86:RoomPlaneParser = null;
      
      private var var_789:int = 0;
      
      private var var_1193:int = 255;
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomUpdateMessage.const_584:
                  _loc2_.setString(RoomObjectVariableEnum.const_544,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_622:
                  _loc2_.setString(RoomObjectVariableEnum.const_719,_loc3_.value);
                  break;
               case RoomObjectRoomUpdateMessage.const_546:
         ...
         if(_loc4_ != null)
         {
            ...
            switch(_loc4_.type)
            {
               case RoomObjectRoomMaskUpdateMessage.const_353:
                  _loc8_ = "null";
                  if(_loc4_.maskCategory == RoomObjectRoomMaskUpdateMessage.const_211)
                  {
                     _loc8_ = "null";
                  }
                  ...
                  _loc7_ = true;
                  break;
               case RoomObjectRoomMaskUpdateMessage.const_670:
            ...
            if(_loc7_)
            {
               ...
               _loc2_.setString(RoomObjectVariableEnum.const_780,_loc10_);
            }
            return;
         }
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.setString(RoomObjectVariableEnum.const_899,param1.toString(),true);
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         if(_loc5_ < 1 || _loc5_ > var_86.planeCount)
         {
            ...
            {
               _loc4_.setNumber(RoomObjectVariableEnum.const_91,0);
            }
            return;
         }
         _loc5_--;
         ...
         {
            _loc4_.setNumber(RoomObjectVariableEnum.const_1216,_loc20_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1291,_loc21_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_1094,_loc22_);
            _loc4_.setNumber(RoomObjectVariableEnum.const_91,_loc5_ + 1);
            var _loc23_:String = "";
            var _loc24_:int = 0;
            var _loc25_:* = null;
            switch(param1.type)
            {
               ...
               case MouseEvent.CLICK:
                  ...
                  if(eventDispatcher != null)
                  {
                     ...
                     else if(_loc13_ == RoomPlaneData.const_143 || _loc13_ == RoomPlaneData.const_223)
                     {
                        _loc27_ = 90;
                        if(_loc11_ != null)
                        {
      ...
      private function updateBackgroundColor() : void
      {
         ...
         if(var_789)
         {
            ...
            {
               _loc6_ = var_1206 >> 16 & 255;
               _loc7_ = var_1206 >> 8 & 255;
               _loc8_ = var_1206 & 255;
               _loc9_ = var_973 >> 16 & 255;
               _loc10_ = var_973 >> 8 & 255;
               _loc11_ = var_973 & 255;
               _loc12_ = (_loc1_ - var_789) / var_1438;
               _loc6_ += (_loc9_ - _loc6_) * _loc12_;
               _loc7_ += (_loc10_ - _loc7_) * _loc12_;
               _loc8_ += (_loc11_ - _loc8_) * _loc12_;
               _loc2_ = (_loc6_ << 16) + (_loc7_ << 8) + _loc8_;
               _loc3_ = var_1439 + (var_1437 - var_1439) * _loc12_;
               _color = _loc2_;
               var_1193 = _loc3_;
            }
            ...
            _loc5_.setNumber(RoomObjectVariableEnum.const_638,_loc2_);
         }
      }
   }
}
