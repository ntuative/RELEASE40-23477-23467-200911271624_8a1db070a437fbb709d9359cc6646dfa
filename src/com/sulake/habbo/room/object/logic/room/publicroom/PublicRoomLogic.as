package com.sulake.habbo.room.object.logic.room.publicroom
{
   ...
   public class PublicRoomLogic extends RoomLogic
   {
      ...
      public function adDelayTimeout() : void
      {
         ...
         _loc1_.setNumber(RoomObjectVariableEnum.const_438,Number(false));
      }
      ...
      override public function initialize(param1:XML) : void
      {
         ...
         _loc2_.setString(RoomObjectVariableEnum.const_288,"");
         _loc2_.setString(RoomObjectVariableEnum.const_522,"");
         _loc2_.setNumber(RoomObjectVariableEnum.const_438,Number(false));
         var_811 = true;
      }
      ...
      override public function processUpdateMessage(param1:RoomObjectUpdateMessage) : void
      {
         ...
         if(_loc3_ != null)
         {
            switch(_loc3_.type)
            {
               case RoomObjectRoomAdUpdateMessage.const_883:
                  _loc2_.setString(RoomObjectVariableEnum.const_288,_loc3_.asset);
                  _loc2_.setString(RoomObjectVariableEnum.const_522,_loc3_.clickUrl);
                  _loc2_.setNumber(RoomObjectVariableEnum.const_438,Number(true));
                  var_931 = getTimer() + _loc2_.getNumber(RoomVariableEnum.const_770);
            }
         }
      }
      ...
      override public function mouseEvent(param1:RoomSpriteMouseEvent, param2:IRoomGeometry) : void
      {
         ...
         switch(_loc3_.type)
         {
            case MouseEvent.CLICK:
               ...
               {
                  _loc7_ = _loc4_.getString(RoomObjectVariableEnum.const_522);
