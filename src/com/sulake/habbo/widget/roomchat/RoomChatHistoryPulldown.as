package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryPulldown
   {
      ...
      private static const const_745:int = 250;
      ...
      public function RoomChatHistoryPulldown(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_42 = param3;
         var_1897 = (_assetLibrary.getAssetByName("chat_grapbar_bg") as BitmapDataAsset).content as BitmapData;
         var_1425 = (_assetLibrary.getAssetByName("chat_grapbar_grip") as BitmapDataAsset).content as BitmapData;
         var_1895 = (_assetLibrary.getAssetByName("chat_grapbar_handle") as BitmapDataAsset).content as BitmapData;
         var_1424 = (_assetLibrary.getAssetByName("chat_grapbar_x") as BitmapDataAsset).content as BitmapData;
         var_1423 = (_assetLibrary.getAssetByName("chat_grapbar_x_hi") as BitmapDataAsset).content as BitmapData;
         var_1899 = (_assetLibrary.getAssetByName("chat_grapbar_x_pr") as BitmapDataAsset).content as BitmapData;
         var_1896 = (_assetLibrary.getAssetByName("chat_history_bg") as BitmapDataAsset).content as BitmapData;
         var_79 = _windowManager.createWindow("chat_history_bg","",HabboWindowType.BITMAP_WRAPPER,HabboWindowStyle.const_38,HabboWindowParam.const_64,new Rectangle(0,0,param3.width,param3.height - const_68),null,0,0) as IBitmapWrapperWindow;
         var_42.addChild(var_79);
         _window = _windowManager.createWindow("chat_pulldown","",HabboWindowType.const_53,HabboWindowStyle.const_38,HabboWindowParam.const_34,new Rectangle(0,0 - const_68,param3.width,const_68),null,0) as IWindowContainer;
         var_42.addChild(_window);
         var_102 = _windowManager.createWindow("REGIONchat_pulldown","",WindowType.const_422,HabboWindowStyle.const_39,0 | 0 | 0 | 0,new Rectangle(0,0,param3.width,param3.height - const_68),null,0) as IRegionWindow;
         if(var_102 != null)
         {
      ...
      public function update(param1:uint) : void
      {
         ...
         {
            case const_343:
               var_79.blend += param1 / const_745;
               _window.blend += param1 / const_745;
               if(false)
               {
                  state = const_285;
               }
               break;
            case const_727:
               var_79.blend = 0 - param1 / const_744;
      ...
      public function containerResized(param1:Rectangle) : void
      {
         ...
         {
            var_102.x = 0;
            var_102.y = 0 - const_68;
            var_102.width = 0 - var_1898;
         }
         if(var_79 != null)
         {
            var_79.rectangle = var_42.rectangle;
            var_79.height = 0 - const_68;
         }
         buildWindowGraphics();
      }
      ...
      private function buildWindowGraphics() : void
      {
         ...
         if(var_1900 == _window.width)
         {
            return;
         }
         var_1900 = _window.width;
         ...
         if(_loc1_ != null && _loc3_ != null && _loc4_ != null)
         {
            if(_loc1_.width > 0 && _loc1_.height > 0)
            {
               ...
               tileBitmapHorz(var_1897.clone(),_loc7_);
               _loc1_.bitmap = _loc7_;
            }
            if(_loc3_.width > 0 && _loc3_.height > 0)
            {
               _loc8_ = new BitmapData(_loc3_.width,_loc3_.height);
               tileBitmapHorz(var_1425.clone(),_loc8_);
               _loc3_.bitmap = _loc8_;
            }
            if(_loc4_.width > 0 && _loc4_.height > 0)
            {
               _loc9_ = new BitmapData(_loc4_.width,_loc4_.height);
               tileBitmapHorz(var_1425.clone(),_loc9_);
