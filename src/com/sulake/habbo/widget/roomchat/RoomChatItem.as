package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatItem
   {
      ...
      private static const const_474:int = 6;
      ...
      {
         _widget.onItemMouseOut(var_922,var_921,_roomId,_roomCategory,param1);
      }
      
      private function onBubbleMouseClick(param1:WindowMouseEvent) : void
      {
         _widget.onItemMouseClick(var_922,var_921,_roomId,_roomCategory,param1);
      }
      ...
      public function define(param1:RoomWidgetChatUpdateEvent) : void
      {
         ...
         var_922 = param1.userId;
         var_745 = param1.userName;
         var_921 = param1.userCategory;
         _message = param1.text;
         var_1147 = param1.userX;
         var_191 = param1.userImage;
         var_920 = param1.userColor;
      ...
      public function renderView() : void
      {
         ...
         switch(var_1148)
         {
            ...
            case RoomWidgetChatUpdateEvent.const_95:
               _loc1_ = "bubble_shout";
               break;
            case RoomWidgetChatUpdateEvent.const_230:
         ...
         if(_loc18_ != null)
         {
            ...
            if(var_920 != 0)
            {
               _loc31_ = uint(var_920 >> 16 & 255);
               _loc32_ = uint(var_920 >> 8 & 255);
               _loc33_ = uint(var_920 >> 0 & 255);
            }
         ...
         if(_loc20_ != null)
         {
            if(var_1148 == RoomWidgetChatUpdateEvent.const_230)
            {
               _loc20_.text = _localizations.registerParameter("widgets.chatbubble.respect","username",var_745);
            }
            else if(var_1148 == RoomWidgetChatUpdateEvent.const_261)
            {
               _loc20_.text = _localizations.registerParameter("widget.chatbubble.petrespect","petname",var_745);
            }
            else
            {
            ...
            _loc20_.x = _width;
            _loc20_.y += var_368;
            _loc20_.width = _loc20_.textWidth + const_474;
            _width += _loc20_.textWidth + const_474;
         }
         if(_loc22_ != null)
         {
            _loc22_.width = _loc19_.textWidth + const_332 + _loc20_.textWidth + const_474;
            _loc38_ = new Matrix();
      ...
      {
         _widget.onItemMouseDown(var_922,var_921,_roomId,_roomCategory,param1);
      }
      ...
      {
         _widget.onItemMouseOver(var_922,var_921,_roomId,_roomCategory,param1);
      }
