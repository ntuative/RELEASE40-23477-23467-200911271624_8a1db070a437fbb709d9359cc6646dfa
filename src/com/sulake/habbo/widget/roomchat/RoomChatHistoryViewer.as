package com.sulake.habbo.widget.roomchat
{
   ...
   public class RoomChatHistoryViewer implements IDisposable
   {
      ...
      private static const const_1092:int = 18;
      ...
      public function RoomChatHistoryViewer(param1:RoomChatWidget, param2:IHabboWindowManager, param3:IWindowContainer, param4:IAssetLibrary)
      {
         ...
         var_161.state = RoomChatHistoryPulldown.const_210;
         ...
         var_50 = param2.createWindow("chatscroller","",HabboWindowType.const_773,HabboWindowStyle.const_39,0 | 0,new Rectangle(param3.rectangle.right - const_481,param3.y,const_481,param3.height - 0),null,0) as IScrollbarWindow;
      ...
      {
         return !!var_299 ? Number(const_481) : Number(0);
      }
      ...
      private function processDrag(param1:Number, param2:Boolean = false) : void
      {
         ...
         if(var_235 > 0 && param2)
         {
            if(var_1269)
            {
               if(Math.abs(param1 - var_235) <= const_905)
               {
                  return;
               }
               var_1269 = false;
            ...
            if(var_299)
            {
               ...
               _loc7_ = true;
               _loc8_ = true;
               if(var_50.scrollV < 1 - const_1092 / var_50.scrollable.scrollableRegion.height)
               {
                  _loc8_ = false;
               }
               if(_loc8_ || var_1496)
      ...
      public function showHistoryViewer() : void
      {
         if(!var_299 && !var_1153)
         {
            ...
            var_161.state = RoomChatHistoryPulldown.const_285;
            if(_widget != null)
            {
      ...
      public function set visible(param1:Boolean) : void
      {
         ...
         var_161.state = param1 == true ? 0 : int(RoomChatHistoryPulldown.const_210);
      }
