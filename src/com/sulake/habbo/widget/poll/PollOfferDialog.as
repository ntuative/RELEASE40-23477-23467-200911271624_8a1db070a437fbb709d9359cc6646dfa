package com.sulake.habbo.widget.poll
{
   ...
   public class PollOfferDialog implements IPollDialog
   {
      ...
      public static const const_236:String = "POLL_OFFER_STATE_UNKNOWN";
      
      public static const const_541:String = "POLL_OFFER_STATE_CANCEL";
      
      public static const const_1217:String = "POLL_OFFER_STATE_OK";
            ...
            if(param1.type == WindowMouseEvent.WINDOW_EVENT_MOUSE_CLICK)
            {
               switch(param2.name)
               {
                  ...
                  case "poll_offer_button_cancel":
                     _state = const_541;
                     _widget.messageListener.processWidgetMessage(new RoomWidgetPollMessage(RoomWidgetPollMessage.const_382,_id));
