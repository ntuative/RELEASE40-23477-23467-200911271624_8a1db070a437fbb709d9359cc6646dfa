package com.sulake.habbo.widget.poll
{
   ...
   public class PollContentDialog implements IPollDialog
   {
      ...
      private function answerPollQuestion() : void
      {
         ...
         var question:Dictionary = var_647[var_970] as Dictionary;
      ...
      private function showCancelConfirm() : void
      {
         ...
         if(!var_290)
         {
            ...
            var_290 = _widget.windowManager.buildFromXML(_loc1_.content as XML,2);
            var_290.center();
            var_290.procedure = cancelConfirmEventProc;
         }
      }
      ...
      private function nextQuestion() : void
      {
         ...
         var _loc7_:int = 0;
         ++var_970;
         if(var_970 < var_647.length)
         {
            _loc1_ = var_647[var_970] as Dictionary;
            if(!_loc1_)
            {
