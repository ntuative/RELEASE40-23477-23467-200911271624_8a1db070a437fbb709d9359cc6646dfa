package com.sulake.habbo.widget.chatinput
{
   ...
   public class RoomChatInputView
   {
      ...
      private static const const_1362:int = 5;
      
      private static const const_474:int = 16;
      
      private static const const_1050:int = 20;
      ...
      private var var_397:Number = 600;
      ...
      public function RoomChatInputView(param1:RoomChatInputWidget, param2:IHabboWindowManager, param3:IAssetLibrary, param4:IHabboLocalizationManager)
      {
         ...
         var_977 = _localization.getKey("widgets.chatinput.mode.whisper",":tell");
         var_1941 = _localization.getKey("widgets.chatinput.mode.shout",":shout");
         var_1942 = _localization.getKey("widgets.chatinput.mode.speak",":speak");
         var_653 = new Timer(1000,1);
         var_653.addEventListener(TimerEvent.TIMER_COMPLETE,onTypingTimerComplete);
         var_798 = new Timer(5000,1);
         var_798.addEventListener(TimerEvent.TIMER_COMPLETE,onIdleTimerComplete);
         createWindow();
         refreshView();
      }
      ...
      private function createWindow() : void
      {
         ...
         _window = _windowManager.createWindow("chatinput_widget_window","",HabboWindowType.const_53,HabboWindowStyle.const_39,0 | 0,new Rectangle(300,400,400,30),null) as IWindowContainer;
         ...
         _loc4_.addEventListener(WindowEvent.const_253,onInputChanged);
      ...
      private function refreshView() : void
      {
         ...
         var _loc12_:* = 0;
         var _loc13_:* = 0;
         var_1943 = _loc2_.width + const_474 + _loc6_.width + const_1050;
         if(_loc7_ != null)
         {
         ...
         if(_loc8_ != null)
         {
            _loc13_ = Number(Math.max(const_1049,_loc8_.width) + const_474);
            _loc8_.x = _loc12_;
      ...
      private function windowKeyEventProcessor(param1:Event = null, param2:IWindow = null) : void
      {
         ...
         if(_loc4_ == Keyboard.BACKSPACE)
         {
            ...
            if(_loc8_ != null)
            {
               ...
               if(_loc10_[0] == var_977 && _loc10_.length == 3 && _loc10_[2] == "")
               {
                  _loc8_.text = "";
                  var_138 = "";
               }
      ...
      public function setMaxWidth(param1:Number) : void
      {
         ...
         {
            _loc3_ = Math.min(int(_loc2_.textWidth),var_397);
         }
         else
         {
            _loc3_ = Math.min(_loc3_,var_397);
         }
