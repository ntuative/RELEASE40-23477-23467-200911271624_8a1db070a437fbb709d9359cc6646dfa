package com.sulake.habbo.widget.furniture.dimmer
{
   ...
   public class DimmerView
   {
      ...
      private var var_1189:XML;
      
      private var var_401:int;
      
      private var var_455:DimmerViewColorGrid;
      
      private var _window:IWindowContainer;
      
      private var var_1880:int;
      
      private var var_333:DimmerViewAlphaSlider;
      ...
      private function createWindow() : void
      {
         ...
         _window = _widget.windowManager.createWindow("dimmerui_container","",HabboWindowType.const_53,HabboWindowStyle.const_38,0 | 0,new Rectangle(const_1020,const_1019,2,2),null,0) as IWindowContainer;
         ...
         if(_loc1_ != null)
         {
            ...
            if(_loc5_ != null)
            {
               var_455 = new DimmerViewColorGrid(this,_loc5_ as IItemGridWindow,_widget.windowManager,_widget.assets);
            }
         }
         _loc1_ = _window.findChildByName("brightness_container");
         if(_loc1_ != null)
         {
            var_333 = new DimmerViewAlphaSlider(this,_loc1_ as IWindowContainer,_widget.assets);
         }
      ...
      public function set selectedColorIndex(param1:int) : void
      {
         ...
         if(var_455 != null)
         {
            var_455.setSelectedColorIndex(param1);
         }
         _widget.previewCurrentSetting();
      }
      ...
      public function set selectedType(param1:int) : void
      {
         ...
         if(var_333 != null)
         {
            var_333.min = _widget.minLights[param1 - 1];
         }
      }
      ...
      private function selectPreset(param1:int) : void
      {
         ...
         selectTab(param1);
         var_952 = _loc2_.light;
         if(var_333 != null)
         {
            var_333.setValue(var_952);
         }
         var_401 = colors.indexOf(_loc2_.color);
         if(var_455 != null)
         {
            var_455.setSelectedColorIndex(var_401);
         }
