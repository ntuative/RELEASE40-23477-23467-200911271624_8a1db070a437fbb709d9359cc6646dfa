package com.sulake.habbo.widget.memenu
{
   ...
   public class MeMenuSettingsView implements IMeMenuView
   {
      ...
      private var var_611:MeMenuSettingsViewSlider;
      
      private var var_1340:BitmapData;
      
      private var var_1341:BitmapData;
      
      private var var_610:Number = 1;
      ...
      public function saveVolume(param1:Number, param2:Boolean = true) : void
      {
         ...
         if(param2)
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_570);
         }
         else
         {
            _loc3_ = new RoomWidgetStoreSettingsMessage(RoomWidgetStoreSettingsMessage.const_573);
         }
      ...
      {
         var_610 = param1.volume;
         if(var_611 != null)
         {
            var_611.setValue(var_610);
         }
         setSoundsOffIcon();
         setSoundsOnIcon();
      }
      ...
      private function createWindow(param1:String) : void
      {
         ...
         var_611 = new MeMenuSettingsViewSlider(this,_window.findChildByName("volume_container") as IWindowContainer,_widget.assets,0,1);
         setSoundsOffIcon();
         setSoundsOnIcon();
         ...
         _widget.messageListener.processWidgetMessage(new RoomWidgetGetSettingsMessage(RoomWidgetGetSettingsMessage.const_618));
      }
      ...
      private function onButtonOut(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc3_)
         {
            case "sounds_off":
               if(var_610 != 0)
               {
                  setBitmapWrapperContent("sounds_off_icon",var_1342);
               }
               break;
            case "sounds_on":
               if(var_610 != 1)
               {
                  setBitmapWrapperContent("sounds_on_icon",var_1341);
               }
         }
      }
      ...
      private function setSoundsOffIcon(param1:BitmapData = null) : void
      {
         ...
         {
            setBitmapWrapperContent("sounds_off_icon",var_1343);
         }
         else
         {
            setBitmapWrapperContent("sounds_off_icon",var_1342);
