package com.sulake.habbo.widget.infostand
{
   ...
   public class InfoStandPetView
   {
      ...
      private const const_1561:uint = 6710886;
      ...
      private const const_1554:String = "energy";
      
      private var var_1096:Map;
      
      private const const_1560:String = "nutrition";
      
      private var var_65:IItemListWindow;
      
      private const const_1559:uint = 3355443;
      
      private var var_212:IBorderWindow;
      
      private const const_1557:int = 158;
      
      private const const_1555:int = 16;
      ...
      private const const_1556:String = "experience";
      ...
      private function createWindow(param1:String) : void
      {
         ...
         if(var_212 != null)
         {
            var_104 = var_212.findChildByName("infostand_element_list") as IItemListWindow;
         }
         _window.name = param1;
      ...
      {
         if(var_104 == null || var_212 == null || var_65 == null)
         {
            return;
         }
      ...
      private function openTrainView() : void
      {
         ...
         var _loc1_:InfoStandPetData = var_1096.getValue(var_836) as InfoStandPetData;
         if(_loc1_ != null)
         {
      ...
      public function update(param1:InfoStandPetData) : void
      {
         ...
         updateStateElement(const_1556,param1.experience,param1.experienceMax);
         updateStateElement(const_1554,param1.energy,param1.energyMax);
         updateStateElement(const_1560,param1.nutrition,param1.nutritionMax);
         ...
         updateWindow();
         var_836 = param1.id;
         var_1096.remove(param1.id);
         var_1096.add(param1.id,param1);
      ...
      protected function onButtonClicked(param1:WindowMouseEvent) : void
      {
         ...
         switch(_loc4_.name)
         {
            ...
            case "btn_petrespect":
               ...
               break;
            case "btn_kick":
               _loc2_ = new RoomWidgetUserActionMessage(RoomWidgetUserActionMessage.const_359,_widget.petData.ownerId);
      ...
      private function createPercentageBar(param1:int, param2:int) : BitmapData
      {
         ...
         var _loc5_:BitmapData = new BitmapData(const_1557,const_1555,false);
