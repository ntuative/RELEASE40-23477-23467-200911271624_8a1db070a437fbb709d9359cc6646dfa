package com.sulake.habbo.messenger
{
   ...
   public class HabboMessenger extends Component implements IHabboMessenger
   {
      ...
      private var var_558:MessengerView;
      ...
      {
         var _loc2_:Conversation = var_557.addConversation(param1);
         if(_loc2_ == null)
         {
         ...
         else
         {
            ...
            var_557.setSelected(_loc2_);
            var_558.openMessenger();
            var_558.refresh(true);
         }
      }
      ...
      {
         var_557.addMessageAndUpdateView(param1);
         if(!var_558.isMessengerOpen())
         {
      ...
      {
         var_557 = new Conversations(new ConversationsDeps(this));
         var_558 = new MessengerView(this);
      ...
      {
         var_557.setOnlineStatusAndUpdateView(param1,param2);
      }
      ...
      public function setHabboToolbarIcon(param1:Boolean, param2:Boolean) : void
      {
         if(!param1)
         {
            var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_168,HabboToolbarIconEnum.MESSENGER));
            return;
         }
         var_204.events.dispatchEvent(new HabboToolbarSetIconEvent(HabboToolbarSetIconEvent.const_111,HabboToolbarIconEnum.MESSENGER));
      ...
      private function onNewConsoleMessage(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_531,_loc2_.senderId,_loc2_.messageText,Util.getFormattedNow());
         addMsg(_loc3_);
      }
      
      public function setFollowingAllowed(param1:int, param2:Boolean) : void
      {
         var_557.setFollowingAllowedAndUpdateView(param1,param2);
      }
      ...
      private function onInstantMessageError(param1:IMessageEvent) : void
      {
         ...
         var _loc3_:Message = new Message(Message.const_849,_loc2_.userId,getInstantMessageErrorText(_loc2_.errorCode),Util.getFormattedNow());
         var_557.addMessageAndUpdateView(_loc3_);
      }
