package com.sulake.habbo.messenger
{
   ...
   public class ConversationView
   {
      ...
      private static const const_1000:int = 10;
      
      private static const const_1001:int = 20;
      
      private static const const_729:int = 100;
       
      
      private var var_1761:IScrollbarWindow;
      
      private var var_133:HabboMessenger;
      
      private var var_1360:IContainerButtonWindow;
      
      private var var_441:Conversation;
      ...
      public function ConversationView(param1:HabboMessenger, param2:IWindowContainer)
      {
         super();
         var_133 = param1;
         var_1360 = initButton("follow_friend",onFollowButtonClick,param2);
         _list = IItemListWindow(param2.findChildByName("msg_list"));
         var_1761 = IScrollbarWindow(param2.findChildByName("scroller"));
      ...
      private function refreshEntry(param1:Boolean, param2:int, param3:Message) : Boolean
      {
         ...
         _loc4_.visible = true;
         var _loc5_:String = param3.type == Message.const_636 || param3.type == Message.const_531 ? param3.time + ": " : "";
      ...
      private function refreshList() : void
      {
         ...
         var _loc1_:int = 0;
         var _loc2_:int = Math.max(0,var_441.messages.length - const_729);
         _loc1_ = 0;
         while(_loc1_ + _loc2_ < var_441.messages.length)
         {
            refreshEntry(true,_loc1_,var_441.messages[_loc1_ + _loc2_]);
            _loc1_++;
         }
         while(true)
         {
      ...
      public function refresh() : void
      {
         ...
         if(var_441 == null || _loc1_.id != var_441.id)
         {
            var_441 = _loc1_;
            refreshList();
            afterResize();
      ...
      public function addMessage(param1:Message) : void
      {
         ...
         if(_loc2_ >= const_729 + const_1001)
         {
            refreshList();
            afterResize();
         }
      ...
      private function onFollowButtonClick(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_133.send(new FollowFriendMessageComposer(var_441.id));
      }
      ...
      private function refreshTextDims(param1:ITextWindow) : void
      {
         ...
         param1.height = param1.textHeight + const_1000;
         param1.invalidate();
      }
   }
}
