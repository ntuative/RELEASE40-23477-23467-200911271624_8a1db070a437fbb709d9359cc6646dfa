package com.sulake.habbo.inventory.achievements
{
   ...
   public class AchievementsModel implements IInventoryModel
   {
      ...
      public function AchievementsModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IHabboLocalizationManager, param6:ISessionDataManager)
      {
         ...
         var_562 = param6;
         var_562.events.addEventListener(BadgeImageReadyEvent.const_159,onBadgeImageReady);
         var_341 = new Array();
      ...
      public function addAchievement(param1:Achievement, param2:Boolean = true) : void
      {
         ...
         while(_loc4_ < var_341.length)
         {
            ...
            if(_loc5_.type == param1.type && _loc5_.level < param1.level)
            {
               ...
               _loc5_.image = var_562.getBadgeImage(param1.badgeId);
               _loc3_ = true;
            }
            _loc4_++;
         }
         if(!_loc3_)
         {
            param1.image = var_562.getBadgeImage(param1.badgeId);
            var_341.push(param1);
         }
         if(param2)
         {
      ...
      {
         if(param1 == InventoryCategory.const_280 && false)
         {
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_562 != null)
            {
               var_562.events.removeEventListener(BadgeImageReadyEvent.const_159,onBadgeImageReady);
               var_562 = null;
            }
            _disposed = true;
         }
