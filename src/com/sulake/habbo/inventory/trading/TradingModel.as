package com.sulake.habbo.inventory.trading
{
   ...
   public class TradingModel implements IInventoryModel, IGetImageListener
   {
      ...
      public static const const_289:uint = 2;
      
      public static const const_424:uint = 4;
      
      public static const TRADING_STATE_CANCELLED:uint = 6;
      
      public static const const_246:uint = 3;
      
      public static const const_153:uint = 1;
      
      public static const const_151:uint = 0;
      
      public static const const_1109:uint = 9;
      
      public static const const_202:uint = 5;
      ...
      public function updateItemGroupMaps(param1:int, param2:Map, param3:int, param4:Map) : void
      {
         ...
         var_418 = false;
         var_586 = false;
         var_52.updateItemList(var_585);
         var_52.updateItemList(var_1053);
      ...
      public function handleMessageEvent(param1:IMessageEvent) : void
      {
         ...
         if(param1 is TradingAlreadyOpenEvent)
         {
            ...
            var_52.alertPopup(TradingView.const_822);
         }
         else if(param1 is TradingAcceptEvent)
         {
            Logger.log("TRADING::TradingAcceptEvent");
            if(TradingAcceptEvent(param1).userID == var_585)
            {
               var_418 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            else
            {
               var_586 = TradingAcceptEvent(param1).userAccepts != 0;
            }
            var_52.updateUserInterface();
         }
         ...
         else if(param1 is TradingCloseEvent)
         {
            ...
            if(_loc2_.userID != var_585)
            {
               var_52.alertPopup(TradingView.const_850);
            }
            close();
         }
      ...
      {
         Logger.log("OLD STATE: " + _state + " NEW STATE: " + param1 + " OWN: " + var_418 + " OTHER: " + var_586);
         ...
         {
            case const_151:
               if(param1 == const_153 || param1 == const_202)
               {
                  _state = param1;
                  _loc2_ = true;
               }
      ...
      public function getOwnItemIdsInTrade() : Array
      {
         ...
         if(var_209 == null || false)
         {
            return _loc1_;
         }
         var _loc4_:int = 0;
         while(_loc4_ < var_209.length)
         {
            _loc2_ = var_209.getWithIndex(_loc4_) as GroupItem;
            if(_loc2_ != null)
            {
               _loc5_ = 0;
      ...
      {
         var_52.setMinimized(param1 != InventoryCategory.const_69);
      ...
      public function close() : void
      {
         if(var_501)
         {
            if(_state != const_151 && _state != const_202)
            {
               requestCancelTrading();
               state = TradingModel.TRADING_STATE_CANCELLED;
            }
            state = const_151;
            var_28.toggleInventorySubPage(InventorySubCategory.const_769);
            var_501 = false;
         }
         var_52.setMinimized(false);
      }
