package com.sulake.habbo.inventory.furni
{
   ...
   public class FurniModel implements IInventoryModel
   {
      ...
      public static const const_301:String = "pets";
      ...
      public function FurniModel(param1:HabboInventory, param2:IHabboWindowManager, param3:IHabboCommunicationManager, param4:IAssetLibrary, param5:IRoomEngine, param6:IHabboLocalizationManager, param7:IHabboConfigurationManager)
      {
         ...
         var_433 = new Timer(const_997,1);
         var_433.addEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
      ...
      {
         return _controller.getSubCategoryViewId() == InventorySubCategory.const_264;
      }
      ...
      public function getAllStripIds(param1:Array) : void
      {
         ...
         var _loc7_:int = 0;
         var _loc8_:int = 0;
         var _loc2_:Array = var_362.getKeys();
         var _loc3_:int = 0;
         while(_loc3_ < _loc2_.length)
         {
            _loc4_ = var_362.getValue(_loc2_[_loc3_]) as Array;
            if(_loc4_ != null)
            {
               _loc5_ = 0;
      ...
      public function dispose() : void
      {
         if(!_disposed)
         {
            ...
            if(var_433 != null)
            {
               var_433.removeEventListener(TimerEvent.TIMER_COMPLETE,onImageUpdateTimerEvent);
               var_433.stop();
               var_433 = null;
            }
            if(var_129 != null)
      ...
      public function createNewGroupItemTemplate(param1:int, param2:String, param3:int, param4:String = null, param5:Boolean = false) : GroupItem
      {
         ...
         var _loc7_:* = null;
         var _loc8_:* = null;
         if(param3 == FurniCategory.const_317)
         {
         ...
         if(var_605 == null)
         {
            var_605 = _windowManager.buildFromXML(_groupItemWindowBase) as IWindowContainer;
         }
         var _loc10_:IWindowContainer = var_605.clone() as IWindowContainer;
      ...
      public function subCategorySwitch(param1:String) : void
      {
         switch(param1)
         {
            case InventorySubCategory.const_264:
               ...
               break;
            case InventorySubCategory.const_769:
               removeAllLocks();
               if(_view != null)
               {
                  _view.updateActionView();
      ...
      {
         if(var_720 && param1.type == RoomEngineObjectEvent.const_205)
         {
      ...
      public function requestSelectedFurniPlacement(param1:Boolean = false) : Boolean
      {
         ...
         if(_loc3_.category == FurniCategory.const_282 || _loc3_.category == FurniCategory.const_317 || _loc3_.category == FurniCategory.const_299)
         {
            if(param1)
            {
               return false;
      ...
      {
         return var_362.getValue(param1);
      }
      
      public function clearFurniList() : void
      {
         var_362 = new Map();
         var_362.add(const_40,new Array());
         var_362.add(const_41,new Array());
         if(_view != null)
         {
            _view.clearViews();
         }
