package com.sulake.habbo.inventory.common
{
   ...
   public class ThumbListManager
   {
      ...
      private var var_938:IThumbListDataProvider;
      ...
      public function ThumbListManager(param1:IAssetLibrary, param2:IThumbListDataProvider, param3:String, param4:String, param5:int, param6:int)
      {
         ...
         var_97 = var_527.height;
         var_937 = param5;
         var_760 = param6;
         var_217 = Math.floor(var_937 / _thumbWidth);
         var_32 = new BitmapData(var_937,var_760);
      }
      ...
      private function removeItemInImage(param1:Point) : void
      {
         ...
         if(var_32.height < var_760)
         {
            _loc12_ = new BitmapData(var_32.width,var_760);
      ...
      private function getList() : Array
      {
         ...
         if(var_938 != null)
         {
            _loc1_ = var_938.getDrawableList();
         }
      ...
      public function updateImageFromList() : void
      {
         ...
         var _loc5_:* = null;
         var _loc6_:* = null;
         var_449 = resolveRowCountFromList();
         if(var_449 == 0)
         {
            var_32 = new BitmapData(var_937,var_760);
            return;
         }
         var_32 = new BitmapData(Math.max(var_217 * _thumbWidth,var_937),Math.max(var_449 * var_97,var_760),true,16777215);
         var_32.fillRect(var_32.rect,4294967295);
         var _loc1_:int = 0;
         var _loc2_:Array = getList();
         var _loc3_:int = 0;
         while(_loc3_ < var_449)
         {
            _loc4_ = 0;
      ...
      public function addItemAsFirst(param1:IThumbListDrawableItem) : void
      {
         ...
         if(_loc3_.x == var_217 && var_32.height < _loc3_.y * var_97)
         {
         ...
         _loc4_ = new Rectangle(0,0,_thumbWidth * (var_217 - 1),var_97);
         _loc2_.copyPixels(var_32,_loc4_,new Point(_thumbWidth,0),null,null,true);
         _loc4_ = new Rectangle(_thumbWidth * (var_217 - 1),0,_thumbWidth,var_32.height);
         _loc2_.copyPixels(var_32,_loc4_,new Point(0,var_97),null,null,true);
         _loc4_ = new Rectangle(0,var_97,_thumbWidth * (var_217 - 1),0 - var_97);
