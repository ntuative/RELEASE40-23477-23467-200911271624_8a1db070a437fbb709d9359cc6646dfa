package com.sulake.habbo.inventory
{
   ...
   public class HabboInventory extends Component implements IHabboInventory
   {
      ...
      private const const_1547:int = 500;
      ...
      override public function dispose() : void
      {
         ...
         if(var_34 != null)
         {
            ...
            var_34.events.removeEventListener(RoomSessionEvent.const_98,roomSessionEventHandler);
            var_34.events.removeEventListener(RoomSessionPropertyUpdateEvent.const_384,roomSessionEventHandler);
      ...
      private function roomSessionEventHandler(param1:RoomSessionEvent) : void
      {
         switch(param1.type)
         {
            ...
            case RoomSessionEvent.const_98:
               _roomSession = null;
               break;
            case RoomSessionPropertyUpdateEvent.const_384:
               petsModel.updatePetsAllowed();
         }
      }
      ...
      {
         return EffectsModel(var_56.getValue(InventoryCategory.const_564));
      }
      ...
      {
         events.dispatchEvent(new HabboInventoryEffectsEvent(HabboInventoryEffectsEvent.const_777));
      }
      
      public function get petsModel() : PetsModel
      {
         return PetsModel(var_56.getValue(InventoryCategory.const_165));
      }
      ...
      public function requestInventoryCategoryInit(param1:String) : void
      {
         ...
         if(_loc2_ != null)
         {
            _loc2_.requestInitialization(const_1547);
         }
      }
      ...
      {
         return AchievementsModel(var_56.getValue(InventoryCategory.const_280));
      }
      ...
      public function setInventoryCategoryInit(param1:String, param2:Boolean = true) : void
      {
         ...
         {
            _loc3_ = var_714.indexOf(param1);
            if(_loc3_ >= 0)
            {
               var_714.splice(_loc3_,1);
            }
         }
      }
      ...
      public function toggleInventorySubPage(param1:String) : void
      {
         ...
         switch(param1)
         {
            case InventorySubCategory.const_264:
      ...
      {
         return TradingModel(var_56.getValue(InventorySubCategory.const_264));
      }
      
      private function onSessionDataManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         var_562 = ISessionDataManager(param2);
         queueInterface(new IIDHabboConfigurationManager(),onConfigurationManagerReady);
      }
      
      public function isInventoryCategoryInit(param1:String) : Boolean
      {
         if(var_714.indexOf(param1) >= 0)
         {
            return true;
         }
         return false;
      ...
      private function onCommunicationComponentInit(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_1297 = new IncomingMessages(this);
      ...
      {
         return BadgesModel(var_56.getValue(InventoryCategory.const_254));
      }
      ...
      private function onRoomSessionManagerReady(param1:IID = null, param2:IUnknown = null) : void
      {
         ...
         var_34.events.addEventListener(RoomSessionEvent.const_98,roomSessionEventHandler);
         var_34.events.addEventListener(RoomSessionPropertyUpdateEvent.const_384,roomSessionEventHandler);
         ...
         var_56.add(InventoryCategory.const_69,_loc3_);
         var _loc4_:BadgesModel = new BadgesModel(this,_windowManager,_communication,_assetLibrary,_localization,var_562);
         var_56.add(InventoryCategory.const_254,_loc4_);
         var _loc5_:EffectsModel = new EffectsModel(this,_windowManager,_communication,_assetLibrary,_localization);
         var_56.add(InventoryCategory.const_564,_loc5_);
         var _loc6_:AchievementsModel = new AchievementsModel(this,_windowManager,_communication,_assetLibrary,_localization,var_562);
         var_56.add(InventoryCategory.const_280,_loc6_);
         var _loc7_:TradingModel = new TradingModel(this,_windowManager,_communication,_assetLibrary,_roomEngine,_localization);
         var_56.add(InventorySubCategory.const_264,_loc7_);
         ...
         var_56.add(InventoryCategory.const_165,_loc9_);
