package com.sulake.habbo.inventory.items
{
   ...
   public class GroupItem implements IGetImageListener
   {
      ...
      protected var var_2146:BitmapData;
      ...
      private const const_1369:Number = 0.2;
      
      protected var var_1289:Boolean;
      
      private const const_1370:Number = 1;
      ...
      public function initImage() : void
      {
         ...
         if(var_2145 == FurniModel.const_40)
         {
      ...
      private function updateThumbData() : void
      {
         ...
         if(_loc1_)
         {
            ...
            if(_loc2_ <= 0)
            {
               _window.blend = const_1369;
               _loc1_.blend = const_1369;
            }
            else
            {
               _window.blend = const_1370;
               _loc1_.blend = const_1370;
            }
         }
         if(isSelected)
         {
