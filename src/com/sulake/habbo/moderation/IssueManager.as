package com.sulake.habbo.moderation
{
   ...
   public class IssueManager
   {
      ...
      public static const const_966:String = "issue_bundle_open";
      
      public static const const_493:String = "issue_bundle_my";
      
      public static const const_825:String = "issue_bundle_picked";
      ...
      private var var_563:IssueBrowser;
      ...
      public function IssueManager(param1:ModerationManager)
      {
         ...
         var_144 = new Map();
         var_826 = new Map();
         var_563 = new IssueBrowser(this,var_62.windowManager,var_62.assets);
         var_675 = [];
         var_827 = [];
         var_1001 = new Map();
      }
      ...
      public function updateIssue(param1:IssueMessageData) : void
      {
         ...
         if(param1.state == IssueMessageData.const_138)
         {
            ...
            _loc8_ = var_827.indexOf(param1.issueId);
            if(_loc8_ == -1 && _loc6_)
            {
      ...
      public function playSound(param1:IssueMessageData) : void
      {
         ...
         if(var_563 == null || !var_563.isOpen())
         {
            var_62.soundManager.playSound(HabboSoundTypesEnum.const_950);
         }
      }
