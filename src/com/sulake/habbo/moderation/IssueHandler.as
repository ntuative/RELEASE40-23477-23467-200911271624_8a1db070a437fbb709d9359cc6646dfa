package com.sulake.habbo.moderation
{
   ...
   public class IssueHandler implements TrackedWindow
   {
      ...
      private var var_369:UserInfoCtrl;
      
      private var var_62:ModerationManager;
      
      private var var_923:UserInfoCtrl;
      
      private var var_152:IssueBundle;
      ...
      private function onRelease(param1:WindowMouseEvent) : void
      {
         ...
         var_62.issueManager.releaseBundle(var_152.id);
         checkAutoHandling();
         dispose();
      }
      ...
      private function createView() : void
      {
         ...
         var_369 = new UserInfoCtrl(_window,var_62);
         var_923 = new UserInfoCtrl(_window,var_62);
         var_369.load(IWindowContainer(_window.findChildByName("caller_user_info")),var_152.getHighestPriorityIssue().reporterUserId);
         var _loc3_:IWindowContainer = IWindowContainer(_window.findChildByName("reported_user_info"));
         if(false)
         {
            var_923.load(_loc3_,var_152.reportedUserId);
         }
         else
         {
      ...
      private function onCloseUseless(param1:WindowMouseEvent) : void
      {
         ...
         var_62.issueManager.closeBundle(var_152.id,1);
         checkAutoHandling();
         dispose();
      }
      ...
      private function updateIssueList() : void
      {
         ...
         var _loc4_:Array = var_152.issues;
         var _loc5_:int = 0;
      ...
      private function onShowChatlog(param1:WindowMouseEvent) : void
      {
         ...
         var _loc2_:int = var_152.getHighestPriorityIssue().issueId;
         var_62.windowTracker.show(new ChatlogCtrl(new GetCfhChatlogMessageComposer(_loc2_),var_62,WindowTracker.const_819,_loc2_),_window,false,false,true);
      }
      ...
      {
         if(var_62 != null && false && var_152 != null)
         {
            var_62.issueManager.removeHandler(var_152.id);
         }
         this.dispose();
      }
      ...
      private function onReporterClicked(param1:WindowMouseEvent) : void
      {
         ...
         if(_loc2_ != 0)
         {
            ...
            var_369 = new UserInfoCtrl(_window,var_62);
            var_369.load(IWindowContainer(_window.findChildByName("caller_user_info")),_loc2_);
         }
      }
      ...
      private function onCloseAbusive(param1:WindowMouseEvent) : void
      {
         ...
         var_62.issueManager.closeBundle(var_152.id,2);
         checkAutoHandling();
         dispose();
      }
      ...
      private function onCloseResolved(param1:WindowMouseEvent) : void
      {
         ...
         var_62.issueManager.closeBundle(var_152.id,3);
         checkAutoHandling();
         dispose();
      }
