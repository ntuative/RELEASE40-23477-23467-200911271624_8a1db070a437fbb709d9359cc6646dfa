package com.sulake.habbo.moderation
{
   ...
   public class UserInfoCtrl implements IDisposable
   {
      ...
      private static const const_747:int = 31536000;
      
      private static const const_750:int = 86400;
      
      private static const const_748:int = 3600;
      
      private static const const_749:int = 60;
      ...
      public static function formatTime(param1:int) : String
      {
         ...
         if(param1 < 2 * const_748)
         {
            return Math.round(param1 / const_749) + " mins ago";
         }
         if(param1 < 2 * const_750)
         {
            return Math.round(param1 / const_748) + " hours ago";
         }
         if(param1 < 2 * const_747)
         {
            return Math.round(param1 / const_750) + " days ago";
         }
         return Math.round(param1 / const_747) + " years ago";
      }
      
      private function prepare() : IWindowContainer
      {
         var _loc1_:IWindowContainer = IWindowContainer(var_790.findChildByName("user_info"));
         if(_loc1_ == null)
         {
            _loc1_ = IWindowContainer(var_55.getXmlWindow("user_info"));
            var_790.addChild(_loc1_);
      ...
      private function onModActionButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_55.windowTracker.show(new ModActionCtrl(var_55,_data.userId,_data.userName),_callerFrame,var_974,false,true);
      }
      ...
      private function onChatlogButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_55.windowTracker.show(new ChatlogCtrl(new GetUserChatlogMessageComposer(_data.userId),var_55,WindowTracker.const_956,_data.userId),_callerFrame,var_974,false,true);
      }
      ...
      private function onRoomVisitsButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_55.windowTracker.show(new RoomVisitsCtrl(var_55,_data.userId),_callerFrame,var_974,false,true);
      }
      ...
      private function onMessageButton(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_55.windowTracker.show(new SendMsgsCtrl(var_55,_data.userId,_data.userName),_callerFrame,var_974,false,true);
      }
