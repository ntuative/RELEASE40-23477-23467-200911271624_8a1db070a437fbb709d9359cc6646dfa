package com.sulake.habbo.moderation
{
   ...
   public class ChatlogCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1376:IMessageComposer;
      ...
      {
         var_800 = IWindowContainer(var_55.getXmlWindow("chatlog_roomheader"));
         var_801 = IWindowContainer(var_55.getXmlWindow("chatlog_chatline"));
         ...
         var_55.connection.send(var_1376);
      ...
      {
         var _loc5_:* = null;
         var _loc2_:IWindowContainer = IWindowContainer(var_800.clone());
      ...
      private function populateChatline(param1:IItemListWindow, param2:ChatlineData, param3:Boolean) : void
      {
         ...
         _loc4_.color = var_1220[param2.chatterId] != null ? (!!param3 ? 4293570819 : uint(4294955520)) : (!!param3 ? 4288861930 : uint(4294967295));
