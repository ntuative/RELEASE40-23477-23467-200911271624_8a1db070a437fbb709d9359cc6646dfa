package com.sulake.habbo.moderation
{
   ...
   public class RoomVisitsCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_1775:IWindowContainer;
      ...
      {
         var _loc3_:IWindowContainer = IWindowContainer(var_1775.clone());
      ...
      {
         var_1775 = IWindowContainer(var_55.getXmlWindow("roomvisits_row"));
      ...
      {
         return WindowTracker.const_1106;
      }
   }
}
