package com.sulake.habbo.moderation
{
   ...
   public class RoomToolCtrl implements IDisposable, TrackedWindow
   {
      ...
      private var var_999:ICheckBoxWindow;
      ...
      private var var_673:ICheckBoxWindow;
      
      private var var_58:IFrameWindow;
      
      private var var_998:ICheckBoxWindow;
      ...
      private function onChatlog(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         var_55.windowTracker.show(new ChatlogCtrl(new GetRoomChatlogMessageComposer(0,_data.flatId),var_55,WindowTracker.const_687,_data.flatId),var_58,false,false,true);
      }
      ...
      private function act(param1:Boolean) : void
      {
         ...
         var _loc2_:int = determineAction(param1,var_673.isSelected);
         var_55.connection.send(new ModeratorActionMessageComposer(ModeratorActionMessageComposer.const_1286,_loc2_,var_377.text,"",""));
         if(false)
         {
            var_55.connection.send(new ModerateRoomMessageComposer(_data.flatId,var_999.isSelected,var_998.isSelected,var_673.isSelected));
         }
         this.dispose();
      }
      ...
      public function populate() : void
      {
         ...
         var_673 = ICheckBoxWindow(var_58.findChildByName("kick_check"));
         var_999 = ICheckBoxWindow(var_58.findChildByName("lock_check"));
         var_998 = ICheckBoxWindow(var_58.findChildByName("changename_check"));
      ...
      public function show() : void
      {
         ...
         var_55.connection.send(new GetModeratorRoomInfoMessageComposer(var_381));
