package com.sulake.habbo.session
{
   ...
   public class UserDataManager implements IUserDataManager
   {
      ...
      {
         return var_357.getValue(param1);
      }
      ...
      public function getUserBadges(param1:int) : Array
      {
         ...
         var _loc2_:* = var_582.getValue(param1) as Array;
         if(_loc2_ == null)
         {
            _loc2_ = [];
         }
      ...
      {
         var_582.remove(param1);
         var_582.add(param1,param2);
      }
      
      public function method_9(param1:IUserData) : void
      {
         var_357.remove(param1.webID);
         _userIds.remove(param1.id);
         var_357.add(param1.webID,param1);
