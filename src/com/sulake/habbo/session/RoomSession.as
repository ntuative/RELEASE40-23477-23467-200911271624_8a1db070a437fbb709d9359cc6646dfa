package com.sulake.habbo.session
{
   ...
   public class RoomSession implements IRoomSession
   {
      ...
      private var var_980:UserDataManager;
      ...
      {
         if(_state == RoomSessionEvent.const_313 && _connection != null)
         {
      ...
      {
         return var_980 as IUserDataManager;
      }
