package com.sulake.core.window.utils
{
   ...
   public class WindowParser implements IWindowParser
   {
      ...
      public static const const_935:String = "_EXCLUDE";
      
      public static const const_1468:String = "_TEMP";
      
      private static const const_1065:RegExp = /^(\s|\n|\r|\t|\v)*/m;
      
      private static const const_1066:RegExp = /(\s|\n|\r|\t|\v)*$/;
       
      
      protected var var_1034:Dictionary;
      
      private var _disposed:Boolean = false;
      
      protected var var_861:Dictionary;
      
      protected var var_1287:Map;
      
      protected var _context:IWindowContext;
      
      protected var var_1288:Dictionary;
      
      protected var var_1033:Dictionary;
      
      public function WindowParser(param1:IWindowContext)
      {
         super();
         _context = param1;
         var_1033 = new Dictionary();
         var_1034 = new Dictionary();
         TypeCodeTable.fillTables(var_1033,var_1034);
         var_861 = new Dictionary();
         var_1288 = new Dictionary();
         ParamCodeTable.fillTables(var_861,var_1288);
         var_1287 = new Map();
      }
      
      private static function trimWhiteSpace(param1:String) : String
      {
         param1 = param1.replace(const_1066,"");
         return param1.replace(const_1065,"");
      }
      ...
      public function dispose() : void
      {
         ...
         if(!_disposed)
         {
            for(_loc1_ in var_1033)
            {
               delete var_1033[_loc1_];
            }
            for(_loc1_ in var_1034)
            {
               delete var_1034[_loc1_];
            }
            for(_loc1_ in var_861)
            {
               delete var_861[_loc1_];
            }
            for(_loc1_ in var_1288)
            {
               delete var_1288[_loc1_];
            }
            var_1287.dispose();
            var_1287 = null;
            _context = null;
            ...
            if(parent != null)
            {
               if(parent is IIterable)
               {
                  if(window.x != rect.x || window.y != rect.y || window.width != rect.width || window.height != rect.height)
                  {
                     ...
                     if((params & 0) == WindowParam.const_150)
                     {
                        window.y = rect.y;
                     }
                  }
         ...
         if(_loc7_ is IIterable)
         {
            ...
            if(_loc9_ > 0)
            {
               ...
               while(_loc12_ < _loc9_)
               {
                  ...
                  if(_loc10_.tags.indexOf(WindowParser.const_935) == -1)
                  {
