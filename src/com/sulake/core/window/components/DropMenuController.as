package com.sulake.core.window.components
{
   ...
   public class DropMenuController extends InteractiveController implements IDropMenuWindow
   {
      ...
      protected static const const_328:String = "_DROPMENU_TITLETEXT";
      ...
      private function getSubMenu() : DropMenuController
      {
         ...
         {
            var_146 = context.create(name + "::submenu","",WindowType.const_403,var_87,0 | 0,_loc1_,subMenuEventProc,null,0,null,["_EXCLUDE"]) as DropMenuController;
         }
         else
         {
      ...
      private function subMenuEventProc(param1:WindowEvent, param2:IWindow) : void
      {
         ...
         else if(param1.type == WindowEvent.const_810)
         {
            if(param2 == var_146)
            {
               closeMenuView();
      ...
      protected function populateMenuItemContainer(param1:Array, param2:DropMenuController, param3:Function) : void
      {
         ...
         while(_loc9_ < _loc5_)
         {
            _loc6_ = context.create(name + "::menu_item_" + _loc9_,param1[_loc9_],WindowType.const_447,var_87,0 | 0 | 0 | 0 | 0,null,param3,null,_loc9_,null,["_EXCLUDE"]) as DropMenuItemController;
         ...
         var _loc10_:IWindow = context.create(name + "::padding","",WindowType.const_312,var_87,0 | 0 | 0 | 0,new Rectangle(0,0,1,2),null,null,0,null,["_EXCLUDE"]);
         ...
         if(var_485 > -1 && _loc5_)
         {
            _loc4_.getListItemAt(var_485).setStateFlag(WindowState.const_46,true);
         }
      }
      ...
      protected function openMenuView() : void
      {
         if(!var_568)
         {
            if(open())
            {
               if(false)
               {
                  populateMenuItemContainer(var_486,getSubMenu(),subMenuEventProc);
                  var_568 = true;
               }
            }
         }
      ...
      public function set selection(param1:int) : void
      {
         ...
         var _loc2_:WindowNotifyEvent = new WindowNotifyEvent(WindowNotifyEvent.const_352,this,null,true);
         update(this,_loc2_);
      ...
      {
         return getChildByName(DropMenuController.const_328) as ITextWindow;
      }
      ...
      protected function closeMenuView() : void
      {
         if(close())
         {
            ...
            var_568 = false;
            getTitleText().text = var_485 < var_486.length && var_485 > -1 ? "null" : caption;
         }
      }
   }
}
