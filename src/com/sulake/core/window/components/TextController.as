package com.sulake.core.window.components
{
   ...
   public class TextController extends WindowController implements ITextWindow, ITextFieldContainer, ILocalizable
   {
      ...
      protected static var var_2204:Rectangle = new Rectangle();
      ...
      protected var var_492:String = "none";
      ...
      protected var var_691:Boolean = false;
      ...
      {
         param1.var_492 = param2;
         param1._field.autoSize = param2 != TextFieldAutoSize.NONE ? "null" : TextFieldAutoSize.NONE;
         param1.refreshTextImage();
      }
      
      private static function method_5(param1:TextController, param2:Number) : void
      {
      ...
      {
         return new Rectangle(var_573 * maxScrollH,var_352 * maxScrollV,width,height);
      }
      ...
      {
         var_573 = param1;
         _field.scrollH = var_573 * Number(_field.maxScrollH);
         refreshTextImage();
      }
      ...
      override public function get properties() : Array
      {
         ...
         _loc1_.push(new PropertyStruct("font_face",defaultTextFormat.font,PropertyStruct.const_222,true));
         _loc1_.push(new PropertyStruct("font_size",defaultTextFormat.size,PropertyStruct.const_1201,true));
         _loc1_.push(new PropertyStruct("text_color",_field.textColor,PropertyStruct.const_348,true));
         _loc1_.push(new PropertyStruct("antialias_type",_field.antiAliasType,PropertyStruct.const_222,true));
         ...
         _loc1_.push(new PropertyStruct("border_color",_field.borderColor,PropertyStruct.const_348,true));
         ...
         _loc1_.push(new PropertyStruct("grid_fit_type",_field.gridFitType,PropertyStruct.const_222,true));
         ...
         _loc1_.push(new PropertyStruct("style_sheet",_field.styleSheet,PropertyStruct.const_222,false));
         ...
         _loc1_.push(new PropertyStruct("auto_size",var_492,PropertyStruct.const_222,var_492 != TextFieldAutoSize.NONE));
      ...
      protected function refreshTextImage() : void
      {
         ...
         if(_loc5_ != _loc3_)
         {
            if(var_492 == TextFieldAutoSize.LEFT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_492 == TextFieldAutoSize.RIGHT)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
            else if(var_492 != TextFieldAutoSize.CENTER)
            {
         ...
         {
            if(var_492 != TextFieldAutoSize.NONE)
            {
               setRectangle(var_22.x,var_22.y,_loc5_ + _loc1_,Math.floor(_field.height) + _loc2_);
               _loc7_ = true;
            }
