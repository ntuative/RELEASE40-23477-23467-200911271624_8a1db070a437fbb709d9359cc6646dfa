package com.sulake.core.window.components
{
   ...
   public class FrameController extends ContainerController implements IFrameWindow
   {
      ...
      private static const const_1052:String = "_HEADER";
      ...
      private var var_1234:IHeaderWindow;
      ...
      private function setupScaling() : void
      {
         ...
         var _loc2_:Boolean = testParamFlag(WindowParam.const_228);
         var _loc3_:Boolean = testParamFlag(WindowParam.const_182);
      ...
      public function get header() : IHeaderWindow
      {
         if(var_1234 == null)
         {
            var_1234 = findChildByTag(const_1052) as IHeaderWindow;
            if(!var_1234)
            {
      ...
      private function marginsCallback(param1:IMargins) : void
      {
         ...
         if(_loc5_)
         {
            _loc2_.setParamFlag(WindowParam.const_232,false);
         }
      ...
      {
         return content != null && var_1282 ? content.iterator : new Iterator(this);
      }
