package com.sulake.core.window.components
{
   ...
   public class InteractiveController extends WindowController implements IInteractiveWindow
   {
      ...
      protected static var var_306:Array;
       
      
      protected var var_2139:uint = 0;
      
      protected var var_854:String = "";
      
      protected var var_412:Array;
      
      protected var var_853:uint = 500;
      ...
      public function InteractiveController(param1:String, param2:String, param3:uint, param4:uint, param5:uint, param6:WindowContext, param7:Rectangle, param8:IWindow, param9:Function, param10:Array = null, param11:Array = null, param12:uint = 0)
      {
         param5 |= 0;
         var_412 = new Array();
         var_412[0] = MouseCursorType.const_320;
         var_412[1] = MouseCursorType.const_38;
         var_412[2] = MouseCursorType.const_320;
         var_412[3] = MouseCursorType.const_320;
         var_412[4] = MouseCursorType.const_38;
         var_412[5] = MouseCursorType.const_38;
         var_412[6] = MouseCursorType.const_320;
         if(var_306 == null)
         {
            var_306 = new Array();
            var_306[0] = WindowState.const_85;
            var_306[1] = WindowState.const_71;
            var_306[2] = WindowState.const_74;
            var_306[3] = WindowState.const_60;
            var_306[4] = WindowState.const_46;
            var_306[5] = WindowState.const_82;
            var_306[6] = WindowState.const_66;
         }
      ...
      {
         var _loc3_:int = var_306.indexOf(param1);
         if(_loc3_ > -1)
         {
