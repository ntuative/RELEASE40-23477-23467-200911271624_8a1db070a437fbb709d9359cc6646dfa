   ...
   public class ScrollableItemListWindow extends WindowController implements IScrollableListWindow
   {
      ...
      protected function get _scrollBar() : IScrollbarWindow
      {
         if(!var_329)
         {
            ...
            if(var_329)
            {
               var_329.addEventListener(WindowEvent.const_263,scrollBarEventProc);
               var_329.addEventListener(WindowEvent.const_188,scrollBarEventProc);
            }
         }
         return var_329;
      }
      ...
      override public function dispose() : void
      {
         if(var_329)
         {
            var_329.removeEventListener(WindowEvent.const_263,scrollBarEventProc);
            var_329.removeEventListener(WindowEvent.const_188,scrollBarEventProc);
            var_329 = null;
         }
         if(_cachedItemList)
         {
      ...
      private function scrollBarEventProc(param1:WindowEvent) : void
      {
         ...
         else if(param1.type == WindowEvent.const_188)
         {
            hideScrollBar();
         }
      }
