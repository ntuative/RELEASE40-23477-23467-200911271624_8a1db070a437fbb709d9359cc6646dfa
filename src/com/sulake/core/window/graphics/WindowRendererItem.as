package com.sulake.core.window.graphics
{
   ...
   public class WindowRendererItem implements IDisposable
   {
      ...
      public function invalidate(param1:IWindow, param2:Rectangle, param3:uint) : Boolean
      {
         ...
         switch(param3)
         {
            ...
            case WindowRedrawFlag.RESIZE:
               ...
               _loc4_ = true;
               break;
            case WindowRedrawFlag.const_457:
               ...
               break;
            case WindowRedrawFlag.const_880:
            ...
            case WindowRedrawFlag.const_875:
               ...
               break;
            case WindowRedrawFlag.const_236:
               _loc4_ = true;
         }
         if(_loc4_)
         {
      ...
      {
         return var_659.getTheActualState(param1.type,param1.style,param1.state) != var_981;
      }
      ...
      public function render(param1:IWindow, param2:Point, param3:Rectangle) : Boolean
      {
         var _loc4_:* = null;
         var _loc10_:* = 0;
         var _loc5_:uint = !!param1.background ? uint(const_756) : uint(const_483);
         var _loc6_:ISkinRenderer = resolveSkinRenderer(param1);
         if(_loc6_ != null)
         {
            _loc5_ = !!_loc6_.isStateDrawable(var_658) ? uint(const_755) : uint(_loc5_);
         }
            ...
            if(_loc4_ != null)
            {
               ...
               if(_loc5_ == const_755)
               {
                  ...
                  if(var_227)
                  {
                     ...
                     _loc6_.draw(param1,var_99,var_99.rect,var_658,false);
                  ...
                  if(param1.blend < 1 && param1.testParamFlag(WindowParam.const_32))
                  {
                     ...
                     _loc4_.draw(var_99,var_858,_colorTransform,null,param3,false);
                     param3.offset(-param2.x,-param2.y);
                  }
                  else
                  {
      ...
      private function resolveSkinRenderer(param1:IWindow) : ISkinRenderer
      {
         ...
         if(_loc2_ == null)
         {
            if(param1.style != WindowStyle.const_895)
            {
               _loc2_ = var_659.getSkinRendererByType(param1.type,WindowStyle.const_895);
            }
         }
         return _loc2_;
      }
