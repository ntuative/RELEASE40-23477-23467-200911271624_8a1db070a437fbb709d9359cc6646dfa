package com.sulake.core.assets
{
   ...
   public class AssetLibraryCollection extends EventDispatcher implements IAssetLibrary
   {
      ...
      protected var var_1030:LoaderContext;
      
      protected var var_44:Array;
      
      protected var var_490:Array;
      
      private var var_577:uint = 0;
      ...
      public function AssetLibraryCollection(param1:String)
      {
         ...
         var_44 = new Array();
         var_490 = new Array();
         var_1030 = new LoaderContext(false,ApplicationDomain.currentDomain,null);
         var_350 = new AssetLibrary("lib-" + var_577++);
         var_44.push(var_350);
      }
      ...
      public function unload() : void
      {
         while(false)
         {
            (var_490.pop() as IAssetLibrary).dispose();
         }
         while(false)
         {
      ...
      public function loadFromFile(param1:URLRequest, param2:Boolean = false, param3:LoaderContext = null) : LibraryLoader
      {
         ...
         var _loc4_:IAssetLibrary = new AssetLibrary("lib-" + var_577++);
         var_490.push(_loc4_);
      ...
      private function loadEventHandler(param1:LibraryLoaderEvent) : void
      {
         ...
         {
            _loc4_ = 0;
            while(_loc4_ < var_490.length)
            {
               _loc3_ = var_490[_loc4_] as IAssetLibrary;
               if(_loc3_.url == _loc2_.url)
               {
                  var_490.splice(_loc4_,1);
                  break;
               }
               _loc4_++;
            }
