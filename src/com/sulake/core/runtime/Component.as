package com.sulake.core.runtime
{
   ...
   public class Component implements IUnknown
   {
      ...
      public static const const_1175:uint = 4;
      ...
      protected var var_1035:uint;
      
      protected var _isDisposed:Boolean = false;
      
      protected var var_852:String = "";
      ...
      protected var var_1839:Boolean = false;
      ...
      public function release(param1:IID) : uint
      {
         ...
         if(_loc2_ == null)
         {
            var_852 = "Attempting to release unknown interface:" + param1 + "!";
            throw new Error(var_852);
         }
         var _loc3_:uint = _loc2_.release();
         if(var_1035 & const_1175)
         {
            if(_loc3_ == 0)
            {
