package com.sulake.core.utils
{
   ...
   public class LibraryLoader extends EventDispatcher implements IDisposable
   {
      ...
      protected static const const_1339:uint = 2;
      
      protected static const const_1340:uint = 1;
      
      protected static const const_1541:int = 5;
      
      protected static const const_1016:uint = 7;
      
      protected static const const_1342:uint = 4;
      
      protected static const const_1341:uint = 3;
       
      
      protected var var_1028:int;
      ...
      protected var var_1282:Boolean = false;
      ...
      protected var var_347:URLRequest;
      
      protected var var_863:Boolean = false;
      
      protected var _name:String;
      
      protected var var_331:Class;
      ...
      protected function prepareLibrary() : void
      {
         ...
         var_331 = this.getDefinition(_name) as Class;
         if(var_331 == null)
         {
            failure("Failed to find resource class \"" + _name + "\" in library " + var_347.url + "!");
            return;
         }
         try
         {
            xmlClass = var_331.manifest as Class;
            if(xmlClass == null)
            {
               return;
            }
      ...
      protected function loadEventHandler(param1:Event) : void
      {
         ...
         if(var_410 == LibraryLoader.const_1341)
         {
            if(analyzeLibrary())
            {
               var_410 |= 0;
         ...
         if(var_410 == LibraryLoader.const_1016)
         {
            var_1282 = true;
            prepareLibrary();
            removeEventListeners();
