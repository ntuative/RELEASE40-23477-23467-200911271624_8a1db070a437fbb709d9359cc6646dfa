package com.sulake.room.renderer
{
   ...
   public class RoomSpriteCanvas implements IRoomRenderingCanvas
   {
      ...
      private var var_830:RoomObjectLocationCache;
      ...
      private var var_2089:Number = -10000000;
      
      private var var_2090:Number = -10000000;
      ...
      private var var_1007:IRoomRenderingCanvasMouseListener = null;
      ...
      public function RoomSpriteCanvas(param1:IRoomSpriteCanvasContainer, param2:String, param3:int, param4:int, param5:int)
      {
         ...
         var_59 = new Sprite();
         var_59.name = "canvas";
         var_59.mouseEnabled = false;
         _master.addChild(var_59);
         var_59.mouseEnabled = true;
         var_59.doubleClickEnabled = true;
         var_59.addEventListener(MouseEvent.CLICK,clickHandler);
         ...
         var_830 = new RoomObjectLocationCache(_loc6_);
         var_298 = new Map();
      ...
      public function initialize(param1:int, param2:int) : void
      {
         ...
         var_1006 = param1;
         var_1008 = param2;
         var_59.graphics.clear();
         var_59.graphics.beginFill(var_19);
         var_59.graphics.drawRect(0,0,param1,param2);
         var_59.mask = var_266;
      }
      ...
      {
         var _loc11_:Number = param1 - var_1006 / 2;
      ...
      public function dispose() : void
      {
         ...
         if(var_483 != null)
         {
            ...
            {
               cleanSprite(var_483[_loc1_] as ExtendedSprite,true);
               _loc1_++;
            }
            var_483 = [];
         }
         ...
         while(_loc1_ < var_298.length)
         {
            ...
            if(_loc2_ != null && _loc3_ != null)
            {
               ...
               if(_loc4_ != null)
               {
                  if(var_1007 != null)
                  {
                     var_1007.processRoomCanvasMouseEvent(_loc3_,_loc4_,_id + var_1488,geometry);
                  }
                  else
                  {
      ...
      {
         if(param1 < 0 || param1 >= var_59.numChildren)
         {
            return null;
         }
         return var_59.getChildAt(param1) as ExtendedSprite;
      }
      ...
      private function cleanSprites(param1:int, param2:Boolean = false) : void
      {
         ...
         while(_loc5_ >= param1)
         {
            _loc3_ = var_59.getChildAt(_loc5_);
            _loc6_ = null;
      ...
      private function checkMouseHits(param1:Number, param2:Number, param3:String, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false, param7:Boolean = false) : Boolean
      {
         ...
         while(_loc14_ >= 0)
         {
            _loc10_ = var_59.getChildAt(_loc14_) as ExtendedSprite;
            if(_loc10_ != null && _loc10_.hitTestPoint(param1 - _loc10_.x,param2 - _loc10_.y))
            {
               if(param3 != MouseEvent.CLICK || !_loc10_.clickHandling)
               {
                  ...
                  {
                     _loc16_ = _loc10_.tag;
                     _loc13_ = var_484.getValue(_loc9_) as ObjectMouseData;
                     if(_loc13_ != null)
                     {
                     ...
                     if(_loc13_ == null)
                     {
                        ...
                        var_484.add(_loc9_,_loc13_);
                     }
                     _loc13_.spriteTag = _loc16_;
                     if(param3 != MouseEvent.MOUSE_MOVE || param1 != var_2089 || param2 != var_2090)
                     {
                        bufferMouseEvent(_loc11_,_loc9_);
                     }
                     _loc12_.push(_loc9_);
         ...
         var _loc15_:Array = var_484.getKeys();
         _loc14_ = 0;
         ...
         while(_loc14_ < _loc15_.length)
         {
            ...
            if(_loc9_ != null)
            {
               _loc13_ = var_484.remove(_loc9_) as ObjectMouseData;
               if(_loc13_ != null)
               {
                  _loc11_ = createMouseEvent(0,0,0,0,MouseEvent.ROLL_OUT,_loc13_.spriteTag,param4,param5,param6,param7);
                  bufferMouseEvent(_loc11_,_loc9_);
      ...
      private function createSprite(param1:SortableSprite, param2:int = -1) : void
      {
         ...
         if(false)
         {
            _loc3_ = var_483.pop() as ExtendedSprite;
         }
         if(_loc3_ == null)
         {
         ...
         if(param2 < 0 || param2 >= var_59.numChildren)
         {
            var_59.addChild(_loc3_);
         }
         else
         {
            var_59.addChildAt(_loc3_,param2);
         }
      ...
      private function checkMouseClickHits(param1:Number, param2:Number, param3:Boolean = false, param4:Boolean = false, param5:Boolean = false, param6:Boolean = false) : Boolean
      {
         ...
         while(_loc12_ >= 0)
         {
            _loc9_ = var_59.getChildAt(_loc12_) as ExtendedSprite;
      ...
      private function updateSprite(param1:int, param2:SortableSprite) : Boolean
      {
         ...
         if(param1 >= var_59.numChildren)
         {
            createSprite(param2);
            return true;
         }
         var _loc3_:ExtendedSprite = var_59.getChildAt(param1) as ExtendedSprite;
         if(_loc3_ != null)
         {
            if(_loc3_.varyingDepth && !param2.varyingDepth)
            {
               var_59.removeChildAt(param1);
               var_483.push(_loc3_);
      ...
      private function renderObject(param1:IRoomObject, param2:String, param3:int) : int
      {
         ...
         var _loc6_:IVector3d = var_830.getScreenLocation(param1,_geometry);
         if(_loc6_ == null)
         {
            return 0;
         }
            ...
            if(_loc12_ != null && _loc12_.visible)
            {
               ...
               if(_loc16_ != null)
               {
                  ...
                  if(_loc18_ != null)
                  {
                     ...
                     if(_loc13_ + _loc18_.width >= 0 && _loc13_ < var_1006 && (_loc14_ + _loc18_.height >= 0 && _loc14_ < var_1008))
                     {
