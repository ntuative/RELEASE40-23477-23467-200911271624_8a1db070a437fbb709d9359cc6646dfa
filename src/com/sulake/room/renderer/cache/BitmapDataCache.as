   ...
   public class BitmapDataCache
   {
      ...
      public function addBitmapData(param1:String, param2:BitmapData) : void
      {
         ...
         if(_loc3_ != null)
         {
            ...
            if(_loc4_ != null)
            {
               var_435 -= _loc4_.width * _loc4_.height * 4;
            }
         ...
         var_435 += param2.width * param2.height * 4;
      }
      
      public function compress() : void
      {
         var_318.sortOn("useCount",0 | 0);
         var _loc1_:* = null;
         var _loc2_:int = 0;
         if(memUsage > memLimit)
         {
            ...
            while(_loc2_ >= 0)
            {
               _loc1_ = var_318[_loc2_] as BitmapDataCacheItem;
               if(_loc1_.useCount == 0)
               {
                  var_318.splice(_loc2_,1);
                  removeItem(_loc1_);
               }
               _loc2_--;
            }
         ...
         {
            _loc1_ = var_318.pop() as BitmapDataCacheItem;
            if(_loc1_ == null)
            {
               break;
            }
      ...
      private function removeItem(param1:BitmapDataCacheItem) : void
      {
         ...
         if(param1 != null)
         {
            ...
            if(_loc2_ != null)
            {
               var_435 -= _loc2_.width * _loc2_.height * 4;
            }
            param1.dispose();
         }
      }
