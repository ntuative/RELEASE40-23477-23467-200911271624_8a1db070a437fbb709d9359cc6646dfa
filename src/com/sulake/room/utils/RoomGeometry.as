package com.sulake.room.utils
{
   ...
   public class RoomGeometry implements IRoomGeometry
   {
      ...
      public static const const_659:Number = 64;
      
      public static const const_894:Number = 32;
      ...
      {
         if(var_383 != param1 * var_1404)
         {
            var_383 = param1 * var_1404;
            ++var_84;
         }
      }
      ...
      {
         if(var_384 != param1 * var_1405)
         {
            var_384 = param1 * var_1405;
            ++var_84;
         }
      }
      ...
      {
         if(var_385 != param1 * var_1403)
         {
            var_385 = param1 * var_1403;
            ++var_84;
         }
      }
      ...
      public function setDepthVector(param1:IVector3d) : void
      {
         ...
         if(_loc7_ != 0)
         {
            ...
            var_949.assign(_loc22_);
         }
         else
         {
            var_949.assign(_loc17_);
         }
         ++var_84;
      }
      ...
      public function getScreenPosition(param1:IVector3d) : IVector3d
      {
         ...
         _loc2_.y *= var_385;
         _loc2_.z *= var_383;
         var _loc3_:Number = Vector3d.scalarProjection(_loc2_,var_949);
         if(_loc3_ < var_2206 || _loc3_ > var_2205)
         {
            return null;
         }
         ...
         if(_loc6_ != null)
         {
            ...
            _loc2_.y *= var_385;
            _loc2_.z *= var_383;
            _loc3_ = Vector3d.scalarProjection(_loc2_,var_949);
         }
      ...
      {
         return new Vector3d(0 * var_384,0 * var_385,0 * var_383);
      }
      ...
      public function getPlanePosition(param1:Point, param2:IVector3d, param3:IVector3d, param4:IVector3d) : Point
      {
         ...
         var _loc8_:Vector3d = new Vector3d(0 * var_384,0 * var_385,0 * var_383);
         var _loc9_:IVector3d = Vector3d.sum(_loc8_,_loc7_);
         var _loc10_:IVector3d = var_88;
         var _loc11_:Vector3d = new Vector3d(param2.x * var_384,param2.y * var_385,param2.z * var_383);
         var _loc12_:Vector3d = new Vector3d(param3.x * var_384,param3.y * var_385,param3.z * var_383);
         var _loc13_:Vector3d = new Vector3d(param4.x * var_384,param4.y * var_385,param4.z * var_383);
